namespace Hidistro.Membership.Core
{
    ...
    {
       static readonly string defaultRoles = null;
       const string PrivilegeCachekey = "DataCache-ManagerPrivileges:{0}";
       static readonly RolesConfiguration rolesConfig = null;
