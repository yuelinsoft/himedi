namespace Hidistro.Subsites.Sales
{
    ...
    {
       static readonly SubsiteSalesProvider _defaultInstance = (DataProviders.CreateInstance("Hidistro.Subsites.Data.SalesData,Hidistro.Subsites.Data") as SubsiteSalesProvider);
        ...
        public abstract bool AddOrderGift(string orderId, GiftInfo gift, int quantity, DbTransaction dbTran);
