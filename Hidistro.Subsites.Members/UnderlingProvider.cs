namespace Hidistro.Subsites.Members
{
    ...
    {
       static readonly UnderlingProvider _defaultInstance = (DataProviders.CreateInstance("Hidistro.Subsites.Data.UnderlingData,Hidistro.Subsites.Data") as UnderlingProvider);
