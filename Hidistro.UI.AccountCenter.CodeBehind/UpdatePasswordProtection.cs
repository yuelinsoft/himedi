namespace Hidistro.UI.AccountCenter.CodeBehind
{
    ...
    {
       IButton btnOK3;
       Literal litOldQuestion;
       HtmlGenericControl LkUpdateTradePassword;
       SmallStatusMessage StatusPasswordProtection;
       HtmlTableRow tblrOldAnswer;
       HtmlTableRow tblrOldQuestion;
       TextBox txtAnswer;
       TextBox txtOdeAnswer;
       TextBox txtQuestion;
       ...
       void btnOK3_Click(object sender, EventArgs e)
        {
            IUser user = Users.GetUser(HiContext.Current.User.UserId, false);
