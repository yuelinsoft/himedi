...
<ul>
    <div class="Product_WareSmall" onClick="ImageClick(1)" style="cursor:pointer;" id="imageStyle1"><Hi:HiImage Id="imgSmall1" runat="server" /></div>
    <div class="Product_WareSmall_1" onClick="ImageClick(2)" style="cursor:pointer;" id="imageStyle2"><Hi:HiImage Id="imgSmall2" runat="server" /></div>
    <div class="Product_WareSmall_1" onClick="ImageClick(3)" style="cursor:pointer;" id="imageStyle3"><Hi:HiImage Id="imgSmall3" runat="server" /></div>
    <div class="Product_WareSmall_1" onClick="ImageClick(4)" style="cursor:pointer;" id="imageStyle4"><Hi:HiImage Id="imgSmall4" runat="server" /></div>
    <div class="Product_WareSmall_1" onClick="ImageClick(5)" style="cursor:pointer;" id="imageStyle5"><Hi:HiImage Id="imgSmall5" runat="server" /></div>
</ul> </td>
            <td width="410" height="410" align="center" valign="middle"><div style="margin:0 auto; position:relative;"><a href="" id="jqzoom"><Hi:HiImage Id="imgBig" runat="server" /></a></div></td>
          </tr>
        </table>
