<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="AddSampleExpressTemplate.aspx.cs" Inherits="Hidistro.UI.Web.Admin.AddSampleExpressTemplate" Title="无标题页" %>
...
<div class="areacolumn clearfix">
      <table width="897" id="controls" height="56" border="0" cellpadding="0" cellspacing="0" style="text-align:center; border:1px #CCC solid;  background-color:#E7E7E7; font-size:12px; padding:0px;
margin:0px 0px 5px 0px;">
  <tr>
    ...
    <td width="73" class="tdline"><form name="form0" style=" padding:8px 0px 0px 0px">
      <label>
       <select 
			    name="fsize" 
				onChange="fontsize();return false;"
				size="1">
				<option value="10">大小
			    <option value="10">10
			    <option value="12">12
    ...
    <td width="146"><form name="form1" style=" padding:8px 0px 0px 0px">
      <label><select 
			    name="ffamily" 
				onChange="fontfamily();return false;"
				size="1">
				<option value="Arial">字体
  ...
  <tr>
    ...
    <td class="tdline"><form name="form10">
      <label><select 
			    name="style" 
				onChange="showstyle();return false;"
				size="1">
				<option value="normal">样式
			    <option value="italic">斜体
    ...
    <td><form name="form11">
      <label><select 
			    name="bottomDropDown" 
				onchange="updateBottom();return false;"
				size="1">
...
<div id="writeroot"></div>
		...
		<div id="flashoutput">
			<noscript>
				...
				<embed name="flexApp" pluginspage="http://www.macromedia.com/go/getflashplayer" src="../../Storage/master/flex/AddSimpleExpressTemplate.swf" height="600" width="900" flashvars="bridgeName=example"/>
				</object>
			</noscript>
			<script language="javascript" charset="utf-8">
				...
				document.write('<embed name="flexApp" pluginspage="http://www.macromedia.com/go/getflashplayer" src="../../Storage/master/flex/AddSimpleExpressTemplate.swf" height="600" width="900" flashvars="bridgeName=example"/>');
