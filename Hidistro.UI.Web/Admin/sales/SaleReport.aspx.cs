...
namespace Hidistro.UI.Web.Admin
{
    ...
    public partial class SaleReport : AdminPage
    {
        ...
        {
            DataTable table = SalesHelper.GetDaySaleTotal(dayYear, dayMonth, dayType);
            ...
            decimal money = SalesHelper.GetMonthSaleTotal(dayYear, dayMonth, dayType);
            if (radioDayForSaleType.SelectedValue == SaleStatisticsType.SaleCounts)
            {
        ...
        {
            DataTable monthSaleTotal = SalesHelper.GetMonthSaleTotal(monthYear, monthType);
            ...
            decimal yearSaleTotal = SalesHelper.GetYearSaleTotal(monthYear, monthType);
            if (radioMonthForSaleType.SelectedValue == SaleStatisticsType.SaleCounts)
            {
        ...
        protected void btnCreateReportOfDay_Click(object sender, EventArgs e)
        {
        ...
        protected void btnCreateReportOfMonth_Click(object sender, EventArgs e)
        {
        ...
        protected void btnQueryDaySaleTotal_Click(object sender, EventArgs e)
        {
            ReBind();
        }

        protected void btnQueryMonthSaleTotal_Click(object sender, EventArgs e)
        {
            ReBind();
        }
