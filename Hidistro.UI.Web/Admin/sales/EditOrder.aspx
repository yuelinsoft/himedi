<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="EditOrder.aspx.cs" Inherits="Hidistro.UI.Web.Admin.EditOrder" %>
...
<div class="dataarea mainwidth databody ">
    ...
    <div class="list">
    <h1>商品列表</h1>    
      <UI:Grid ID="grdProducts" runat="server" OnRowDeleting="grdProducts_RowDeleting" OnRowCommand="grdProducts_RowCommand"  AutoGenerateColumns="false" HeaderStyle-CssClass="table_title" DataKeyNames="SkuId" SortOrderBy="SkuId" SortOrder="DESC" GridLines="None" AllowSorting="true" Width="100%">
                    ...
                    <ItemTemplate>
                      ...
                      <div style="float:left;margin-left:10px;line-height:22px;"><span><a href='<%#"../../ProductDetails.aspx?ProductId="+Eval("ProductId") %>' target="_blank"><%# Eval("ItemDescription") %></a>
                       ...
                       <span><a href='<%# Globals.ApplicationPath+"/FavourableDetails.aspx?activityId="+Eval("PurchaseGiftId") %>' target="_blank"><%# Eval("PurchaseGiftName")%></a>
                            <a href='<%# Globals.ApplicationPath+"/FavourableDetails.aspx?activityId="+Eval("WholesaleDiscountId") %>' target="_blank"><%# Eval("WholesaleDiscountName")%></a></span>
                      </div>
                    </ItemTemplate>
                </asp:TemplateField>
...
<table width="200" border="0" cellspacing="0">
      ...
      <asp:GridView ID="grdOrderGift" runat="server" OnRowDeleting="grdOrderGift_RowDeleting" AutoGenerateColumns="false" DataKeyNames="GiftId" SortOrderBy="GiftId" SortOrder="DESC" GridLines="None" HeaderStyle-CssClass="table_title" AllowSorting="true" Width="100%" >
            <Columns>
...
<h1>订单实收款结算</h1>
        ...
        <table width="200" border="0" cellspacing="0">
          ...
          <tr>
            ...
            <td colspan="2" class="a_none"><Hi:FormatedMoneyLabel ID="oderItemAmount" runat="server"  /><small class="colorE"><asp:Literal ID="litOderItem" runat="server" /></small></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td colspan="2" class="a_none"><asp:Literal ID="litIntegral" runat ="server"></asp:Literal></td>
          </tr>
          <tr class="bg">
        ...
        <asp:Button ID="btnUpdateOrderAmount" OnClientClick="return PageIsValid();" OnClick="btnUpdateOrderAmount_Click" runat="server" Text="保存修改"  CssClass="submit_DAqueding" style="float:left"></asp:Button>
            </div>
    </div>
  </div>
