<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="AddOrderLookupItem.aspx.cs" Inherits="Hidistro.UI.Web.Admin.AddOrderLookupItem" %>
...
<div class="columnleft clearfix">
  <ul><li><a href="OrderLookupLists.aspx"><span>订单可选项列表</span></a></li></ul>
</div>
      <div class="columnright">
        ...
        <div class="Steps">
          <ul>
              <li class="fui">第一步：基本信息</li>    
              <li class="iocns "></li>
              <li class="huang">第二步：设置可选项内容</li>
              <li class="iocns "></li>
              <li class="fui">第三步：完成</li>
          </ul>
          </div>
          <div class="colorE">当前订单可选项：<span class="colorG"><asp:Literal runat="server" ID="litName" /></span></div>
          <div class="content">
          ...
          <div class="Pg_15">
          <input name="" type="button" value="添加可选项内容" onclick="DivWindowOpen(500,420,'DivAddOrderLookupItem');" class="submit_bnt2"/>
          </div>
        <div class="Pg_15">
            <asp:Button Text="完 成" runat="server" ID="lkOver" class="submit_DAqueding "/>
      </div>
...
<div class="Pop_up" id="DivAddOrderLookupItem" style="display:none;">
  <h1>添加可选项内容</h1>
