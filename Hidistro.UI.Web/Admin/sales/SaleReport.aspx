<%@ Page Language="C#" AutoEventWireup="true" Inherits="Hidistro.UI.Web.Admin.SaleReport" CodeFile="SaleReport.aspx.cs" MasterPageFile="~/Admin/Admin.Master" %>
      ...
      <div>
	    <div class="searcharea clearfix br_search">
		    ...
		    <li><span>请选择：</span><span class="colorR">年</span><li>
		     ...
		     <li> <asp:Button ID="btnQueryMonthSaleTotal" runat="server" class="searchbutton" 
                     Text="查询" onclick="btnQueryMonthSaleTotal_Click" /></li>
             <li><p><asp:LinkButton ID="btnCreateReportOfMonth" runat="server" Text="生成报告" 
                     onclick="btnCreateReportOfMonth_Click"/></p></li>
			</ul>
	  </div>
        ...
        <h3>按日统计</h3>
          <div class="searcharea clearfix br_search">
            <ul class="a_none_left">
              ...
              <li>
                <asp:Button ID="btnQueryDaySaleTotal" runat="server" Text="查询" 
                      class="searchbutton" onclick="btnQueryDaySaleTotal_Click" />
              </li>
              <li>
                <p> <asp:LinkButton ID="btnCreateReportOfDay" runat="server" Text="生成报告" 
                        onclick="btnCreateReportOfDay_Click" /></p>
              </li>
            </ul>
          </div>
          <div class="functionHandleArea clearfix m_none">
