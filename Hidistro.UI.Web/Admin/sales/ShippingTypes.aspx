<%@ Page Language="C#" AutoEventWireup="true" Inherits="Hidistro.UI.Web.Admin.ShippingTypes" CodeFile="ShippingTypes.aspx.cs" MasterPageFile="~/Admin/Admin.Master" %>
...
<!--<div class="optiongroup mainwidth">
		<ul>
			<li class="menucurrent"><a href="#"><span>配送方式管理</span></a></li>
			<li class="optionend"><a href="AddShippingType.aspx"><span>添加配送方式</span></a></li>
		</ul>
	</div>-->
<div class="dataarea mainwidth td_top_ccc">
 ...
 <!--<div class="toptitle">
  <em><img src="../images/08.gif" width="32" height="32" /></em>
<h1 class="title_height">编辑配送方式</h1>
 <span>每一个配送方式都是针对一个物流公司并且结合物流公司的到达地区和收费标准设置的，您可以为不同的到达地区设置不同的收费标准</span>
 </div>-->
          ...
          <HeaderStyle CssClass="table_title" />
            <Columns>   
                    ...
                    <asp:TemplateField HeaderText="">
                        <ItemTemplate>
                            <a href='<%# "EditShippingTemplate.aspx?TemplateId="+Eval("TemplateId") %>' target="_blank"><%# Eval("TemplateName")%></a>
                        </ItemTemplate>
                    </asp:TemplateField>
