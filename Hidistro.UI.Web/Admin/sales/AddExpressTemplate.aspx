<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="AddExpressTemplate.aspx.cs" Inherits="Hidistro.UI.Web.Admin.AddExpressTemplate" Title="无标题页" %>
      ...
      <option value="right">居右 </option>
		...
		<div id="flashoutput">
			<noscript>
				...
				<embed name="flexApp" pluginspage="http://www.macromedia.com/go/getflashplayer" src="../../Storage/master/flex/AddExpressTemplate.swf" height="600" width="900" flashvars="bridgeName=example"/>
				</object>
			</noscript>
			<script type="text/javascript" language="javascript" charset="utf-8">
				...
				document.write('<embed name="flexApp" pluginspage="http://www.macromedia.com/go/getflashplayer" src="../../Storage/master/flex/AddExpressTemplate.swf" height="600" width="900" flashvars="bridgeName=example"/>');
