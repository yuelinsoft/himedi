<%@ Page Language="C#" AutoEventWireup="true" Inherits="Hidistro.UI.Web.Admin.ArticleCategories" CodeFile="ArticleCategories.aspx.cs"
        ...
        <div class="Pa_15">
            ...
            <div class="pageHandleArea">
                <ul class="a_none_left">
                    <li><a href="AddArticleCategory.aspx" class="submit_jia">添加文章分类</a></li>
                </ul>
            </div>
            <!--结束-->
        </div>
                ...
                <Columns>
                   ...
                   <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass="td_left td_right_fff">
                        ...
                        <ItemTemplate>
                            <span class="submit_bianji"><a href='<%# "EditArticleCategory.aspx?CategoryId="+Eval("CategoryId") %>'>编辑</a></span>
