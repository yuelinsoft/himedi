<%@ Page Language="C#" AutoEventWireup="true" Inherits="Hidistro.UI.Web.Admin.ManageLeaveComments" CodeFile="ManageLeaveComments.aspx.cs" MasterPageFile="~/Admin/Admin.Master" %>
      ...
      <UI:Grid ID="leaveList" runat="server" ShowHeader="true" AutoGenerateColumns="false" DataKeyNames="LeaveId" GridLines="None" Width="100%" HeaderStyle-CssClass="table_title">
            <Columns>                 
                ...
                <asp:TemplateField HeaderText="发件人" HeaderStyle-CssClass="td_right td_left">
                 <itemstyle  CssClass="Name" />
                    <ItemTemplate>
                          <a href='<%# Globals.GetAdminAbsolutePath(string.Format("/member/ManageMembers.aspx?searchKey={0}",Eval("UserName"))) %>'><asp:Literal ID="litUserName" runat="server" Text='<%#  Globals.HtmlDecode(Eval("UserName").ToString())%>' /></a>
                    </ItemTemplate>
                </asp:TemplateField>
