<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="EditHelpCategory.aspx.cs" Inherits="Hidistro.UI.Web.Admin.EditHelpCategory" %>
...
<div class="areacolumn clearfix">
		<div class="columnleft clearfix">
                  <ul>
                        <li><a href="HelpCategories.aspx"><span>帮助分类管理</span></a></li>
                  </ul>
    </div>
