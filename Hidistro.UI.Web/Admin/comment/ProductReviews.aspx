<%@ Page Language="C#" AutoEventWireup="true" Inherits="Hidistro.UI.Web.Admin.ProductReviews" CodeFile="ProductReviews.aspx.cs" MasterPageFile="~/Admin/Admin.Master" %>
			...
			<ul>
				...
				<li>
					<abbr class="formselect">
					  店铺分类：<Hi:ProductCategoriesDropDownList ID="dropCategories" runat="server" />
					</abbr>
				</li>
				<li>
		   ...
		   <asp:DataList ID="dlstPtReviews" runat="server" DataKeyField="ReviewId" Style="width: 100%;" >
                ...
                <ItemTemplate>
                    <tr>
                      ...
                      <td><span  class="Name"> <a href='<%# Globals.GetAdminAbsolutePath(string.Format("/member/MemberDetails.aspx?userId={0}",Eval("UserId"))) %>'><asp:Label ID="lblName" runat="server" Text='<%# Eval("UserName") %>' /></a></span></td>
