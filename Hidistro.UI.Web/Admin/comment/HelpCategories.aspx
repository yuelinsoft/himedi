<%@ Page Language="C#" AutoEventWireup="true" Inherits="Hidistro.UI.Web.Admin.HelpCategories" CodeFile="HelpCategories.aspx.cs" MasterPageFile="~/Admin/Admin.Master" %>
...
<div class="optiongroup mainwidth">
	...
	<div class="dataarea mainwidth">
		<!--搜索-->
		 <div class="Pa_15">
		 <a href="AddHelpCategory.aspx" class="submit_jia">添加帮助分类</a>
		 </div>
     ...
     <UI:Grid ID="grdHelpCategories" runat="server" ShowHeader="true" AutoGenerateColumns="false" DataKeyNames="CategoryId" HeaderStyle-CssClass="table_title" GridLines="None" Width="100%">
            <Columns>   
                ...
                <asp:TemplateField HeaderText="操作" ItemStyle-Width="20%" HeaderStyle-CssClass="td_left td_right_fff">
                    <ItemTemplate>
                    <span class="submit_bianji"><a href='<%# "EditHelpCategory.aspx?CategoryId=" + Eval("CategoryId")%> '>编辑</a></span>
