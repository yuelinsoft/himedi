<%@ Page Language="C#" AutoEventWireup="true" Inherits="Hidistro.UI.Web.Admin.ArticleList" CodeFile="ArticleList.aspx.cs" MasterPageFile="~/Admin/Admin.Master" %>
		    ...
		    <li><span>关键字：</span><span><asp:TextBox ID="txtKeywords" runat="server" CssClass="forminput" /></span></li>
				<li>
					<abbr class="formselect">
						<Hi:ArticleCategoryDropDownList ID="dropArticleCategory" NullToDisplay="全部" runat="server" cssclass="forminput" />
					</abbr>
				</li>
                ...
                <asp:TemplateField HeaderText="添加时间" HeaderStyle-CssClass="td_right td_left">
                 ...
                 <asp:TemplateField HeaderText="操作" ItemStyle-Width="20%" HeaderStyle-CssClass=" td_left td_right_fff">
                     <ItemTemplate>
                        ...
                        <span class="submit_bianji"> <a href="<%# "../../admin/comment/RelatedArticleProduct.aspx?ArticleId=" + Eval("ArticleId") %>" target="_blank">相关商品</a></span>
                     </ItemTemplate>
                 </asp:TemplateField>
            </Columns>
        </UI:Grid>        
