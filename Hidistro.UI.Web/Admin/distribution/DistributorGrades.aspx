<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="DistributorGrades.aspx.cs" Inherits="Hidistro.UI.Web.Admin.DistributorGrades" %>
...
<div class="optiongroup mainwidth">
		<ul>
            <li class="optionstar"><a href="ManageDistributor.aspx" class="optionnext"><span>分销商管理</span></a></li>
            <li class="menucurrent"><a href="DistributorGrades.aspx" class="optioncurrentend"><span class="optioncenter">分销商等级管理</span></a></li>
		</ul>
	</div>
	<!--选项卡-->
	<div class="dataarea mainwidth">
	  <!--搜索-->
	  <div class="toptitle"> <em><img src="../images/02.gif" width="32" height="32" /></em> <span class="title_height">使用分销等级区分分销商的级别，不同级别的分销商可以享受不同的折扣率</span> </div>
	  <!--结束-->
