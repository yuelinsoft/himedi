<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="AcceptDistributorRequest.aspx.cs" Inherits="Hidistro.UI.Web.Admin.AcceptDistributorRequest" %>
...
<div class="areacolumn clearfix">
		<div class="columnleft clearfix">
                  <ul>
                        <li><a href="DistributorRequests.aspx"><span>招募分销商</span></a></li>
                  </ul>
</div>
