<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="DistributionReport.aspx.cs" Inherits="Hidistro.UI.Web.Admin.DistributionReport" %>
...
<div class="optiongroup mainwidth">
		<ul>
			<li class="menucurrent"><a href="#"><span>分销生意报告</span></a></li>
      ...
      <div>
	    <div class="searcharea clearfix br_search">
		    ...
		    <li><span>请选择：</span><span class="colorR">年</span>
             ...
             <li><Hi:SaleStatisticsTypeRadioButtonList ID= "radioMonthForSaleType" runat="server" /></li>           
        ...
        <h3>按日统计</h3>
          <div class="searcharea clearfix br_search">
            <ul class="a_none_left">
              ...
              <li><span><Hi:SaleStatisticsTypeRadioButtonList ID= "radioDayForSaleType" runat="server" /></span></li>
