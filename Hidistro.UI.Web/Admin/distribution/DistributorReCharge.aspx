<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" Inherits="Hidistro.UI.Web.Admin.DistributorReCharge" CodeFile="DistributorReCharge.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
 ...
 <div class="dataarea mainwidth databody">
    <div class="title m_none td_bottom"> 
      ...
      <h1>预付款账户加款</h1>
      <span>管理员手工给分销商的预付款账户加款</span></div>
    <div class="datafrom">
