<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="AccountSummaryList.aspx.cs" Inherits="Hidistro.UI.Web.Admin.AccountSummaryList" %>
  ...
  <div class="bottomBatchHandleArea clearfix">
	...
	<div class="Pop_up" id="addAttribute" style=" display:none;">
      <h1>给“<span id="spUserName"></span>”账户加款 </h1>
        <div class="img_datala"><a href="#" onclick="CloseDiv();"><img src="../images/icon_dalata.gif" width="38" height="20" /></a></div>
      <div class="mianform">
        <ul>
                  <li> <span class="formitemtitle Pw_100">可用余额：</span>
                    <strong class="colorA"><span id="spUseableBalance"></span></strong> 元
                  </li>
