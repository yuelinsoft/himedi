<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="MemberGrades.aspx.cs" Inherits="Hidistro.UI.Web.Admin.MemberGrades" %>
...
<span>使用会员等级区分买家的级别，不同级别的买家可以享受不同的折扣率.</span></div>
	  <!-- 添加按钮-->
	  <div class="btn"><a href="AddMemberGrade.aspx" class="submit_jia">添加会员等级</a></div>
	  <!--结束-->
	  <!--数据列表区域-->
  <div class="datalist">
