<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="OverdueCoupons.aspx.cs" Inherits="Hidistro.UI.Web.Admin.OverdueCoupons" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentHolder" Runat="Server">
  ...
  <div class="optiongroup mainwidth">
      <ul>
        <li class="optionstar"><a href="NewCoupons.aspx"><span>新创建的优惠券</span></a></li>
        <li><a href="EngagedCoupons.aspx" class="optionnext"><span>使用中的优惠券</span></a></li>
        <li class="menucurrent"><a href="javascript:void(0);"><span class="optioncenter">过期的优惠券</span></a></li>
      </ul>
</div>
  ...
  <div class="dataarea mainwidth databody">
    <div class="title"> <em><img src="../images/06.gif" width="32" height="32" /></em>
      <h1>优惠券管理 </h1>
     <span>管理店铺过期的优惠券，您可以删除过期的优惠券</span></div>
    <!-- 添加按钮-->
    <div class="btn">
