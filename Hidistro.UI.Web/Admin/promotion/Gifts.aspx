<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="Gifts.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Gifts" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentHolder" Runat="Server">
  ...
  <h1 class="title_height"> 礼品管理 </h1>
		...
		<div class="searcharea clearfix br_search">
		  <ul>
          <li><a href="AddGift.aspx" class="submit_jia">添加新礼品</a></li>
		...
		<div class="datalist">
		  <UI:Grid ID="grdGift" runat="server" AutoGenerateColumns="false" DataKeyNames="GiftId" SortOrderBy="GiftId" SortOrder="DESC" GridLines="None" HeaderStyle-CssClass="table_title"  Width="100%" >
            <Columns>
                <UI:CheckBoxColumn HeaderStyle-CssClass="td_right td_left" HeaderStyle-Width="5%" />
                <asp:TemplateField HeaderText="礼品图片" HeaderStyle-CssClass="td_right td_left" HeaderStyle-Width="15%">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="采购价" SortExpression="PurchasePrice" HeaderStyle-CssClass="td_right td_left" HeaderStyle-Width="5%">
                 ...
                 <asp:TemplateField HeaderText="兑换所需积分" SortExpression="CostPrice" HeaderStyle-CssClass="td_right td_left" HeaderStyle-Width="10%">
                  ...
                  <asp:TemplateField HeaderText="允许下载" SortExpression="CostPrice" HeaderStyle-CssClass="td_right td_left" HeaderStyle-Width="10%">
                    <itemtemplate>
