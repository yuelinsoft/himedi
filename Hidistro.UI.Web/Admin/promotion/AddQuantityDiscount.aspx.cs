...
namespace Hidistro.UI.Web.Admin
{
    ...
    public partial class AddQuantityDiscount : AdminPage
    {
                            ...
                            case PromotionActionStatus.Success:
                                {
                                    ...
                                    Response.Redirect(Globals.GetAdminAbsolutePath("/promotion/PromotionProducts.aspx?ActiveId=" + activeIdByPromotionName), true);
                                    return;
                                }
