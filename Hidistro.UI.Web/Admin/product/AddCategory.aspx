<%@ Page Language="C#" AutoEventWireup="true" Inherits="Hidistro.UI.Web.Admin.AddCategory" CodeFile="AddCategory.aspx.cs" MasterPageFile="~/Admin/Admin.Master" %>
...
<div class="areacolumn clearfix">
		<div class="columnleft clearfix">
                  <ul>
                        <li><a href="ManageCategories.aspx"><span>店铺分类管理</span></a></li>
                  </ul>
</div>
          ...
          <div class="formitem validator2">
            <ul>
              ...
              <li> <span class="formitemtitle Pw_100">选择上级分类：</span>
                <Hi:ProductCategoriesDropDownList ID="dropCategories" runat="server" />
              </li>
              ...
              <asp:TextBox ID="txtPageKeyTitle" runat="server"  CssClass="forminput"></asp:TextBox>
               ...
               <li class="m_none"><span class="formitemtitle Pw_100">分类广告：</span>
				  ...
				  <span style="padding-left:100px;">
				   	<div id="notes1"><Kindeditor:KindeditorControl ID="fckNotes1" runat="server" Width="550"  Height="300px"/></div>
					<div id="notes2" style="display:none;"><Kindeditor:KindeditorControl ID="fckNotes2" runat="server" Width="550"  ImportLib="false" Height="300px"/></div>
					<div id="notes3" style="display:none;"><Kindeditor:KindeditorControl ID="fckNotes3" runat="server" Width="550"  ImportLib="false" Height="300px"/></div>
				  </span>
               </li>
              <li>&nbsp;</li>
            </ul>
