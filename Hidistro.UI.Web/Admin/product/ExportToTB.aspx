<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="ExportToTB.aspx.cs" Inherits="Hidistro.UI.Web.Admin.product.ExportToTB" %>
...
<div class="optiongroup mainwidth">
		<ul>
			<li class="optionstar"><a href="exporttoyfx.aspx"><span>导出为易分销数据包</span></a></li>
			<li><a href="exporttohishop.aspx" class="optionnext"><span>导出为Hishop数据包</span></a></li>
...
<div class="dataarea mainwidth">
		...
		<div class="searcharea clearfix" >
		    <ul>
		        ...
		        <li><asp:Button ID="btnSearch" runat="server" Text="筛选" CssClass="searchbutton" OnClick="btnSearch_Click"/></li>
		    </ul>
		</div>
		<!--结束-->
         <div class="functionHandleArea clearfix" style="height:70px;">
			...
			<div class="pageNumber">
                <asp:Button runat="server" ID="btnExport" Text="导 出" CssClass="submit_DAqueding inbnt" OnClick="btnExport_Click" />
			</div>
			<!--结束-->
	  ...
	  <div class="datalist">
	    <UI:Grid runat="server" ID="grdProducts" Width="100%" AllowSorting="true" ShowOrderIcons="true" GridLines="None" DataKeyNames="ProductId"
                    SortOrder="Desc"  AutoGenerateColumns="false" OnRowCommand="grdProducts_RowCommand" HeaderStyle-CssClass="table_title">
