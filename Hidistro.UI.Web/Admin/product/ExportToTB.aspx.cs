...
namespace Hidistro.UI.Web.Admin.product
{
    ...
    public partial class ExportToTB : AdminPage
    {
        int? _categoryId;
        DateTime? _endDate;
        bool _includeInStock= false;
        bool _includeOnSales = false;
        bool _includeUnSales = false;
        int? _lineId;
        string _productCode;
        string _productName;
        DateTime? _startDate;
        ...
        {
            AdvancedProductQuery query = new AdvancedProductQuery();
            query.Keywords = _productName;
            query.ProductCode = _productCode;
            query.CategoryId = _categoryId;
            query.ProductLineId = _lineId;
            ...
            query.IncludeInStock = _includeInStock;
            query.IncludeOnSales = _includeOnSales;
            query.IncludeUnSales = _includeUnSales;
            if (_categoryId.HasValue)
            {
                query.MaiCategoryPath = CatalogHelper.GetCategory(_categoryId.Value).Path;
            }
        ...
        protected void grdProducts_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Remove")
            {
                ...
                int proid = (int)grdProducts.DataKeys[rowIndex].Value;
                string proids = (string)ViewState["RemoveProductIds"];
                ...
                {
                    proids = proids + "," + proid.ToString();
                }
                ViewState["RemoveProductIds"] = proids;
                BindProducts();
            }
        }
