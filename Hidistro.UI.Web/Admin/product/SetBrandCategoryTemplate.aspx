<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="SetBrandCategoryTemplate.aspx.cs" Inherits="Hidistro.UI.Web.Admin.SetBrandCategoryTemplate" Title="无标题页" %>
...
<div class="dataarea mainwidth databody">
    ...
    <span style="color:#F97A0A;">
        您还可以通过FTP上传您所需要的模板文件到对应模板的brandcategorythemes目录下
    </span>
    </div>
