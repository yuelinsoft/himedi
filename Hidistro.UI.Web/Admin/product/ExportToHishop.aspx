<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="ExportToHishop.aspx.cs" Inherits="Hidistro.UI.Web.Admin.product.ExportToHishop" %>
...
<div class="optiongroup mainwidth">
		<ul>
			<li class="optionstar"><a href="exporttoyfx.aspx" class="optionnext"><span>导出为易分销数据包</span></a></li>
			<li class="menucurrent"><a><span>导出为Hishop数据包</span></a></li>
