<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="EditStocks.aspx.cs" Inherits="Hidistro.UI.Web.Admin.product.EditStocks" Title="无标题页" %>
...
<div class="dataarea mainwidth databody">
    ...
    <div class="datalist">
	      <UI:Grid ID="grdSelectedProducts" DataKeyNames="SkuId" runat="server" ShowHeader="true" AutoGenerateColumns="false" HeaderStyle-CssClass="table_title" GridLines="None" Width="100%">
                    ...
                    <asp:TemplateField HeaderText="商品" ItemStyle-Width="60%" HeaderStyle-CssClass="td_right td_left">
                        <ItemTemplate>
