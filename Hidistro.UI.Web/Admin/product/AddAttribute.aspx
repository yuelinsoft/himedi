<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="AddAttribute.aspx.cs" Inherits="Hidistro.UI.Web.Admin.product.AddAttribute" %>
...
<div class="areacolumn clearfix">
      ...
      <div class="columnright">
        ...
        <div class="Pg_15">
            <asp:Button CssClass="submit_DAqueding" Text="下一步" runat = "server" ID="btnNext" OnClick="btnNext_Click" />
        </div>
