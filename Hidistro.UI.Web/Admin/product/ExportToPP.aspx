<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="ExportToPP.aspx.cs" Inherits="Hidistro.UI.Web.Admin.product.ExportToPP" %>
...
<div class="optiongroup mainwidth">
		<ul>
			...
			<li><a href="exporttohishop.aspx"><span>导出为Hishop数据包</span></a></li>
...
<div class="dataarea mainwidth">
	  ...
	  <div class="datalist">
	    <UI:Grid runat="server" ID="grdProducts" Width="100%" AllowSorting="true" ShowOrderIcons="true" GridLines="None" DataKeyNames="ProductId"
                    SortOrder="Desc"  AutoGenerateColumns="false" HeaderStyle-CssClass="table_title" OnRowCommand="grdProducts_RowCommand">
