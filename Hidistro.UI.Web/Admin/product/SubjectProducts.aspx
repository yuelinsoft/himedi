<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="SubjectProducts.aspx.cs" Inherits="Hidistro.UI.Web.Admin.SubjectProducts"  %>
...
<div class="Goodsgifts">
    ...
    <div class="optiongroup mainwidth">
      <ul>
			<li id="spLatest" ><a href="SubjectProducts.aspx?subjectType=4"><span>最新商品</span></a></li>
            <li id="spRecommended"><a href="SubjectProducts.aspx?subjectType=3"><span>推荐商品</span></a></li>
            <li id="spHotsale"><a href="SubjectProducts.aspx?subjectType=1"><span>热卖商品</span></a></li>
            <li id="spSpecialOffer"><a href="SubjectProducts.aspx?subjectType=2"><span>特价商品</span></a></li>
		</ul>
    </div>
