<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="ProductUnSales.aspx.cs" Inherits="Hidistro.UI.Web.Admin.ProductUnSales" %>
...
<div class="optiongroup mainwidth">
		<ul>
		     <li class="optionstar"><a href="ProductOnSales.aspx" class="optionnext"><span>出售中的商品</span></a></li>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ItemStyle-Width="35%" HeaderText="商品" HeaderStyle-CssClass="td_right td_left">
                            ...
                            <div style="float:left; margin-right:10px;">
                                <a href='<%#"../../UnProductDetails.aspx?productId="+Eval("ProductId")%>' target="_blank">
                                        <Hi:ListImage ID="ListImage1"  runat="server" DataField="ThumbnailUrl40"/>      
                                 </a> 
                                 </div>
                                 <div style="float:left;">
                                 <span class="Name"> <a href='<%#"../../UnProductDetails.aspx?productId="+Eval("ProductId")%>' target="_blank"><%# Eval("ProductName") %></a></span>
...
<input type="hidden" id="hdPenetrationStatus" value="0" runat="server" />
    ...
    <p><span class="formitemtitle Pw_100" style="float:left;">同时撤销铺货：</span>
                <asp:CheckBox ID="ck_Instock" Text="撤销铺货" Checked="true" runat="server" /></p>
                <p style="color:Red; width:100%">（当选择撤销铺货时，所有子站关于此商品信息以及促销活动信息都将被删除。）</p>
                <p> <asp:Button ID="btnStockPentrationStauts" runat="server" Text="确定" CssClass="submit_DAqueding" OnClientClick="javascript:if($('#ctl00_contentHolder_ck_Instock').attr('checked')){$('#ctl00_contentHolder_hdPenetrationStatus').val('1')}else{$('#ctl00_contentHolder_hdPenetrationStatus').val('0')}" /></p>
    </div>
</div>
