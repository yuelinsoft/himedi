<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="EditAttribute.aspx.cs" Inherits="Hidistro.UI.Web.Admin.product.EditAttribute" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="validateHolder" runat="server">
 <script type="text/javascript" language="javascript">
           function InitValidators() {
               initValid(new InputValidator('ctl00_contentHolder_attributeView_txtName', 1, 15, false, null, '属性的名称，最多15个字符'));
           }
