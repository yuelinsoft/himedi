<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="ManageLogs.aspx.cs" Inherits="Hidistro.UI.Web.Admin.ManageLogs" %>
...
<div class="optiongroup mainwidth">
	  <ul>
	    <li class="optionstar"><a href="Roles.aspx"><span>部门管理</span></a></li>
        <li><a href="Managers.aspx" class="optionnext"><span>管理员管理</span></a></li>
        <li class="menucurrent"><a href="ManageLogs.aspx" class="optioncurrentend"><span class="optioncenter">操作日志</span></a></li>
      </ul>
</div>
	<div class="dataarea mainwidth">
    <div class="toptitle"> <em><img src="../images/01.gif" width="32" height="32" /></em>
      <span class="title_height">查看各个管理员的历史操作记录</span>
    </div>
