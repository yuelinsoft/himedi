<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="ManageHotKeywords.aspx.cs" Inherits="Hidistro.UI.Web.Admin.ManageHotKeywords" %>
...
<div class="optiongroup mainwidth">
      <ul>
        <li class="optionstar"><a href="ManageThemes.aspx"><span>模板管理</span></a></li>
        <li><a href="FriendlyLinks.aspx" class="optionnext"><span>友情链接</span></a></li>
        <li class="menucurrent"><a href="ManageHotKeywords.aspx"><span class="optioncenter">热门关键字</span></a></li>
  ...
  <div class="dataarea mainwidth databody">
    ...
    <!-- 添加按钮-->
    <div class="btn">    
      <a class="submit_jia" href="javascript:DivWindowOpen(520,350,'AddHotKeyword');" >添加热门关键字</a>
  ...
  <div class="mianform validator2">
    ...
    <tr>
        <td width="30%" style="text-align:right; vertical-align:top;">商品主分类：<em >*</em></td><td>    <Hi:ProductCategoriesDropDownList IsTopCategory="true" ID="dropCategory" runat="server" /></td>
    </tr>
    <tr>
    ...
    <ul>
          ...
          <li> <span class="formitemtitle Pw_100">关键字名称：<em >*</em></span>
            ...
            <input type="hidden" runat="server" id="hicategory" />       
             <p id="ctl00_contentHolder_txtEditHotKeywordTip">不能为空，只能输入汉字,数字,英文,下划线,减号,不能以下划线、减号开头或结尾</p>
          </li>
    </ul>
        <ul class="up Pa_100">
