<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="ProductSubject.aspx.cs" Inherits="Hidistro.UI.Web.Admin.ProductSubject" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
 <div class="dataarea mainwidth td_top_ccc">
  ...
  <h1 class=" title_height">“<a href="ManageThemes.aspx"><asp:Literal runat="server" ID="litThemName"/></a>”模板的商品栏目</h1>
