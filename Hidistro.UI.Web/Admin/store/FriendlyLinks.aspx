<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="FriendlyLinks.aspx.cs" Inherits="Hidistro.UI.Web.Admin.FriendlyLinks" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
    <div class="optiongroup mainwidth">
      <ul>
        <li class="optionstar"><a href="ManageThemes.aspx" class="optionnext"><span>模板管理</span></a></li>
        <li class="menucurrent"><a href="FriendlyLinks.aspx" ><span class="optioncenter">友情链接</span></a></li>
...
<div class="blank12 clearfix"></div>
 <div class="dataarea mainwidth databody">
    ...
    <!-- 添加按钮-->
    <div class="btn">
      <a href="AddFriendlyLink.aspx" class="submit_jia">添加友情链接</a>
    </div>
    <!--结束-->
    <div class="datalist">
