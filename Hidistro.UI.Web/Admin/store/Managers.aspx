<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="Managers.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Managers" %>
...
<div class="optiongroup mainwidth">
	  <ul>
        <li class="optionstar"><a href="Roles.aspx" class="optionnext"><span>部门管理</span></a></li>
        <li class="menucurrent"><a href="Managers.aspx"><span class="optioncenter">管理员管理</span></a></li>
	    <li class="optionend"><a href="ManageLogs.aspx"><span>操作日志</span></a></li>
      </ul>
</div>
	<div class="dataarea mainwidth">
    <div class="toptitle"> <em><img src="../images/01.gif" width="32" height="32" /></em> <span class="title_height">对店铺的管理员账号进行管理，还可以调整管理员所属的部门 </span> </div>
    <!--搜索-->
