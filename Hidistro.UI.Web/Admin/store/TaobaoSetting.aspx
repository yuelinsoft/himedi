<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="TaobaoSetting.aspx.cs" Inherits="Hidistro.UI.Web.Admin.TaobaoSetting" Title="无标题页" %>
        ...
        <div class="formitem validator1" id="settaobao" runat="server">
          <ul>
           ...
           <ul class="btntf Pa_198 clearfix">
		    <asp:Button ID="btnOK" runat="server" Text="绑定淘宝" CssClass="submit_DAqueding inbnt" OnClientClick="return PageIsValid();" />
			</ul>
        </div>
      </div>
           <div class="clear"></div>
