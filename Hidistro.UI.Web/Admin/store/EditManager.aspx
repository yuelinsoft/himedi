<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="EditManager.aspx.cs" Inherits="Hidistro.UI.Web.Admin.EditManager" %>
...
<div class="areacolumn clearfix">
      ...
      <div class="formitem validator2">
        <ul>
          ...
          <li> <span class="formitemtitle Pw_100">所属部门：<em >*</em></span><abbr class="formselect">
           <Hi:RoleDropDownList ID="dropRole" runat="server" AllowNull="false" />
          </abbr></li>
          <li> <span class="formitemtitle Pw_100">邮件地址：<em >*</em></span>
