<%@ Page Language="C#" MasterPageFile="~/Shopadmin/Shopadmin.Master" AutoEventWireup="true" CodeFile="MyProductOnSales.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.MyProductOnSales" %>
...
<div class="optiongroup mainwidth">
		<ul>
			...
			<li class="optionend"><a href="MyProductUnclassified.aspx"><span>未分类商品</span></a></li>
                     ...
                     <Columns>
                        ...
                        <ItemTemplate>
                         ...
                         <Hi:MoneyColumnForAdmin HeaderText=" 一口价"
                            ItemStyle-Width="70" DataField="SalePrice"  HeaderStyle-CssClass="td_right td_left"  />
                        <Hi:MoneyColumnForAdmin HeaderText="采购价"
                            ItemStyle-Width="70" DataField="PurchasePrice" HeaderStyle-CssClass="td_right td_left"  />                    
