<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="MyProducts.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.MyProducts" %>
...
<div class="dataarea mainwidth td_top_ccc">
    <div class="toptitle"> <em><img src="../images/03.gif" width="32" height="32" /></em>
      <h1 class="title_height">查看店铺分类下的商品</h1>
    </div>
    <!--搜索-->
...
<div class="columnleft2">
		  <div class="columnleftmenu2 clearfix">
		    <ul>		      
              <li class="itempitchon"><span>店铺分类管理</span></li>
              <li><a href="AddMyCategory.aspx"><span>添加店铺分类</span></a></li>		      
	        </ul>
	      </div>
