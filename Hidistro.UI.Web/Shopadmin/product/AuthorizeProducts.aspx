<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="AuthorizeProducts.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.product.AuthorizeProducts" %>
  ...
  <span class="title_height">授权产品目录,分销商可在此选择需要分销的产品进行下载,下载的产品将会放入仓库,分销商需对商品相关信息编辑后才能上架到自己的店铺中</span> 
		...
		<div class="searcharea clearfix br_search">
			<ul>
			  ...
			  <li><asp:Button ID="btnSearch" runat="server" class="searchbutton" Text="查询" OnClick="btnSearch_Click" /></li>
		...
		<!--结束-->
		  ...
		  <div class="batchHandleArea">
				<ul>
                    ...
                    <span class="submit_btnxiajia m_none"><asp:LinkButton runat="server" ID="lkbtnDownloadCheck" OnClick="lkbtnDownloadCheck_Click">下载</asp:LinkButton></span></li>
				</ul>
			</div>
      </div>
		<!--数据列表区域-->
		...
		<UI:Grid ID="grdAuthorizeProducts" DataKeyNames="ProductId" runat="server" ShowHeader="true" AutoGenerateColumns="false" HeaderStyle-CssClass="table_title" GridLines="None" Width="100%" OnRowCommand="grdAuthorizeProducts_RowCommand" >
                    <Columns> 
  ...
  <div class="bottomBatchHandleArea clearfix">
			 <div class="batchHandleArea">
		      <ul>
		        ...
		        <span class="submit_btnxiajia m_none"><asp:LinkButton runat="server" ID="lkbtnDownloadCheck1" OnClick="lkbtnDownloadCheck_Click">下载</asp:LinkButton></span>
		        </li>
	          </ul>
	        </div>
		</div>
