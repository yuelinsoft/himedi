<%@ Page Language="C#" MasterPageFile="~/Shopadmin/Shopadmin.Master" AutoEventWireup="true" CodeFile="MyDeductSettings.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.MyDeductSettings" Title="无标题页" %>
        ...
        <div class="formitem validator1">
          <ul>
            <li><span class="formitemtitle Pw_198">推荐人提成比例：<em >*</em></span>
              ...
              <p id="txtDeductTip" runat="server">设置订单完成以后推荐人的提成比例</p>
            </li>
          </ul>
