<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Order_ShippingAddress.ascx.cs" Inherits="Hidistro.UI.Web.Shopadmin.Order_ShippingAddress" %>
...
<h1>物流信息</h1>
        ...
        <tr id="tr_company" runat="server" visible="false">
          ...
          <tr>
            ...
            <td width="25%"><span class="Name"><asp:LinkButton runat="server" ID="lkBtnEditShippingAddress" Text="修改收货地址" OnClientClick="javascript:DivWindowOpen(600, 400, 'dlgShipTo'); return false;" Visible="false"></asp:LinkButton></span></td>
          </tr>
          <tr>
