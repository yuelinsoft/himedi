<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PurchaseOrder_Charges.ascx.cs" Inherits="Hidistro.UI.Web.Shopadmin.PurchaseOrder_Charges" %>
...
<div class="Settlement">
  <table width="200" border="0" cellspacing="0">
    ...
    <tr>
      ...
      <td width="10%"><asp:Literal ID="litOptionPrice" runat="server" /></td>
      <td width="75%"> (<asp:Literal ID="litOderItem" runat="server" />)</td>
    </tr>
    <tr>
