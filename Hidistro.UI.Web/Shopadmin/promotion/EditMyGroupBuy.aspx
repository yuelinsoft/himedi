<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="EditMyGroupBuy.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.EditMyGroupBuy" %>
...
<div class="columnleft clearfix"><ul><li><a href="MyGroupBuys.aspx"><span>团购活动管理</span></a></li></ul></div>
      ...
      <li>
         <asp:Button ID="btnUpdateGroupBuy" runat="server" Text="保存" OnClientClick="return PageIsValid();"  CssClass="submit_DAqueding float" OnClick="btnUpdateGroupBuy_Click"  />
         <asp:Button ID="btnFinish" runat="server" Text="结束活动" Visible="false"  CssClass="submit_DAqueding float" OnClick="btnFinish_Click"  />
         <asp:Button ID="btnSuccess" runat="server" Text="活动成功" Visible="false"  CssClass="submit_DAqueding float" OnClick="btnSuccess_Click"  />
         <asp:Button ID="btnFail" runat="server" Text="活动失败"  Visible="false"   CssClass="submit_DAqueding float" OnClick="btnFail_Click"  />
         </li>
        </ul>
      </div>      
  </div>
