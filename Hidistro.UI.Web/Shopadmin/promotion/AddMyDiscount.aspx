<%@ Page Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="AddMyDiscount.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.AddMyDiscount" %>
...
<div class="dataarea mainwidth databody">
 ...
 <div class="datafrom">
    <div class="formitem validator4">
                <ul>
                <li>
                  <Hi:DistributorPromoteview id="addpromoteSales" runat="server">
                        <SkinTemplate> 
                        <ul>
                ...
                <Kindeditor:KindeditorControl FileCategoryJson="~/Shopadmin/FileCategoryJson.aspx" UploadFileJson="~/Shopadmin/UploadFileJson.aspx" FileManagerJson="~/Shopadmin/FileManagerJson.aspx" ID="fckDescription" runat="server" Width="550px"  Height="200px"/>
                  ...
                  <li> <span class="formitemtitle Pw_110">打折方式：</span>
                     <Hi:DistributorDiscountValueTypeRadioButtonList id="radioValueType" onclick="DiscountType(this);" runat="server" style="display:inline;"></Hi:DistributorDiscountValueTypeRadioButtonList>
                  </li>
