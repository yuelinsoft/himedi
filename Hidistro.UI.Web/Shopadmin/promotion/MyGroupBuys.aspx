<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="MyGroupBuys.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.MyGroupBuys" %>
...
<div class="functionHandleArea clearfix m_none">
	  ...
	  <div class="datalist">
            ...
            <Columns>                 
                 ...
                 <asp:TemplateField HeaderText="商品名称" HeaderStyle-CssClass="td_right td_left"  ItemStyle-Width="18%">
                       <ItemTemplate>
                 ...
                 <asp:TemplateField HeaderText="结束时间"  ItemStyle-Width="14%"  HeaderStyle-CssClass="td_right td_left" >
                       <ItemTemplate>
                           <Hi:FormatedTimeLabel ID="lblEndDate" Time='<%#Eval("EndDate") %>' runat="server"></Hi:FormatedTimeLabel>
                       </ItemTemplate>
                 </asp:TemplateField>
                  <asp:TemplateField HeaderText="违约金"  ItemStyle-Width="8%"  HeaderStyle-CssClass="td_right td_left" >
                       <ItemTemplate>
