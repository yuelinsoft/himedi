<%@ Page Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="MyGiftList.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.MyGiftList" Title="无标题页" %>
		  ...
		  <UI:Grid ID="grdGift" runat="server" AutoGenerateColumns="false" DataKeyNames="GiftId" SortOrderBy="GiftId" SortOrder="DESC" GridLines="None" HeaderStyle-CssClass="table_title"  Width="100%" >
            <Columns>
               ...
               <asp:TemplateField HeaderText="礼品名称" SortExpression="Name" HeaderStyle-CssClass="td_right td_left" HeaderStyle-Width="20%">
                ...
                <asp:TemplateField HeaderText="兑换所需积分" SortExpression="PurchasePrice" HeaderStyle-CssClass="td_right td_left" HeaderStyle-Width="15%">
                    <itemtemplate>
