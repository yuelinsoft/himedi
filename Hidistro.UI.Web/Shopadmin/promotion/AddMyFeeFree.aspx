<%@ Page Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="AddMyFeeFree.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.AddMyFeeFree"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
    ...
    <div class="formitem validator4">
                ...
                <asp:Button ID="btnAddFeeFree" OnClientClick="return PageIsValid();" runat="server" Text="添加"  CssClass="submit_DAqueding inbnt" OnClick="btnAddFeeFree_Click" ></asp:Button>
      </ul>
      </div>
    </div>
</div>
