<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="AddMyAdvPosition.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.AddMyAdvPosition" %>
       ...
       <div class="formitem validator2">
        <ul>
          ...
          <li> <span class="formitemtitle Pw_100">广告位内容：</span>
            <span style="float:left;"><Kindeditor:KindeditorControl FileCategoryJson="~/Shopadmin/FileCategoryJson.aspx" UploadFileJson="~/Shopadmin/UploadFileJson.aspx" FileManagerJson="~/Shopadmin/FileManagerJson.aspx" ID="fcContent" runat="server" Width="550px" IsAdvPositions="true" Height="200px" /></span>
          </li>
      </ul>
