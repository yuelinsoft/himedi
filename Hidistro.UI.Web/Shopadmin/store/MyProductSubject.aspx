<%@ Page Language="C#" MasterPageFile="~/ShopAdmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="MyProductSubject.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.MyProductSubject" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
 <div class="dataarea mainwidth td_top_ccc">
  ...
  <h1 class=" title_height">“<a href="ManageMyThemes.aspx"><asp:Literal runat="server" ID="litThemName"/></a>”模板的商品栏目</h1>
  <span>模板中，“Common_GoodsList_Default”标签使用列表(列表中的行数代表此标签的使用次数，栏目编号是此标签在模板中设置的参数)</span>
</div>
		<!--数据列表区域-->
		<div class="datalist">
		 <UI:Grid ID="grdSubjects" runat="server" AutoGenerateColumns="false" ShowHeader="true" DataKeyNames="SubjectId" GridLines="None" Width="100%" HeaderStyle-CssClass="table_title" >                                                        
                        <Columns>   
                            ...
                            <asp:TemplateField HeaderText="关联标签" HeaderStyle-CssClass="td_right td_left">
                                <ItemTemplate>
                                    <asp:Label ID="lblTags" runat="server" Text='<%#Bind("Type") %>' ></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="价格区间" HeaderStyle-CssClass="td_right td_left">
                                <ItemTemplate>
