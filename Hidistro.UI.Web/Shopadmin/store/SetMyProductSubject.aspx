<%@ Page Language="C#" MasterPageFile="~/ShopAdmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="SetMyProductSubject.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.SetMyProductSubject" %>
        ...
        <ul>
          ...
          <li> <span class="formitemtitle Pw_100">关联标签：</span>
            <asp:ListBox ID="radProductTags" runat="server">
             ...
             <p>限制栏目版块只显示选中标签下的商品，所有表示不限制</p>
             <li> <span class="formitemtitle Pw_100">关联店铺分类：</span>
                <Hi:DistributorProductCategoriesListBox runat="server" ID="listProductCategories" SelectionMode="Multiple" />
                       </li>
