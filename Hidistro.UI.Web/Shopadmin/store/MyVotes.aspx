<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="MyVotes.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.MyVotes" %>
...
<div class="optiongroup mainwidth">   
  ...
  <div class="dataarea mainwidth databody">
    ...
    <asp:DataList ID="dlstVote" runat="server" Width="100%" DataKeyField="VoteId" 
            ondeletecommand="dlstVote_DeleteCommand" onitemcommand="dlstVote_ItemCommand" 
            onitemdatabound="dlstVote_ItemDataBound">
                <HeaderTemplate>
