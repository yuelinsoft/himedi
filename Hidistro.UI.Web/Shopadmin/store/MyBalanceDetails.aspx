<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="MyBalanceDetails.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.MyBalanceDetails" %>
...
<div class="datalist">
 <UI:Grid ID="grdBalanceDetails" runat="server" AutoGenerateColumns="false" GridLines="None" ShowHeader="true" AllowSorting="true" Width="100%"  HeaderStyle-CssClass="table_title" SortOrder="DESC">
                            <Columns>
			                    ...
			                    <Hi:MoneyColumnForAdmin HeaderText="账户总额" DataField="Balance" HeaderStyle-CssClass="td_left td_right_fff" />				                   	       			      	        
	                        </Columns> 
	          </UI:Grid>
