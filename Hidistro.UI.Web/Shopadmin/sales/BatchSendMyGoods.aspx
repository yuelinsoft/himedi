<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="BatchSendMyGoods.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.sales.BatchSendMyGoods" %>
     ...
     <UI:Grid ID="grdOrderGoods" runat="server" ShowHeader="true" AutoGenerateColumns="false" DataKeyNames="OrderId" HeaderStyle-CssClass="table_title" GridLines="None" Width="100%">
            <Columns>
                <asp:TemplateField HeaderText="订单编号">
                    <itemtemplate>
                         <Hi:DistributorOrderDetailsHyperLink ID="lkbtnOrderDetails" OrderStatusCode='<%# Eval("OrderStatus") %>' OrderId='<%# Eval("OrderId") %>' Target="_blank" Text='<%# Eval("OrderId") %>' runat="server" ForeColor="BlueViolet"/>
                    </itemtemplate>
                </asp:TemplateField>
