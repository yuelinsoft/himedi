...
{
    public partial class MyEmailSettings : DistributorPage
    {
        ...
        private void btnChangeEmailSettings_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                siteSettings.EmailSettings = Cryptographer.Encrypt(data.SettingsXml);
            }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    txtSelectedName.Value = siteSettings.EmailSender.ToLower();
                    ConfigData data = new ConfigData(Cryptographer.Decrypt(siteSettings.EmailSettings));
