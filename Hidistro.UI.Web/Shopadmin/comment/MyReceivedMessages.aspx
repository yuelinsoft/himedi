<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="MyReceivedMessages.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.MyReceivedMessages" %>
      ...
      <UI:Grid ID="messagesList" runat="server" ShowHeader="true" AutoGenerateColumns="false" DataKeyNames="ReceiveMessageId" GridLines="None" Width="100%" HeaderStyle-CssClass="table_title">
            <Columns>                 
                 ...
                 <asp:TemplateField HeaderText="标题" HeaderStyle-CssClass="td_right td_left">
                  <itemstyle  CssClass="Name" />
                    <ItemTemplate >
                        ...
                        <a href='<%# Globals.ApplicationPath+string.Format("/Shopadmin/comment/ReplyMyReceivedMessages.aspx?ReceiveMessageId={0}", Eval("ReceiveMessageId"))%>' class='<%# Eval("IsRead").ToString()=="False"? "cstrong":"" %>'>
                ...
                <asp:TemplateField HeaderText="发件人" HeaderStyle-CssClass="td_right td_left">
                 <itemstyle  CssClass="Name" />
                    <ItemTemplate>
                        <a href='<%# Globals.ApplicationPath+string.Format("/shopadmin/Underling/ManageUnderlings.aspx?Username={0}",Eval("Addresser")) %>'><span class='<%# Eval("IsRead").ToString()=="False"? "cstrong":"" %>'><asp:Literal ID="litAddresser" runat="server" Text='<%# Eval("Addresser")%>' /></span></a>
                    </ItemTemplate>
                </asp:TemplateField>
