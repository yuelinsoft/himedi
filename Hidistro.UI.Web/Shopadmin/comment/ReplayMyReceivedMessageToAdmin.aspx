<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="ReplayMyReceivedMessageToAdmin.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.ReplayMyReceivedMessageToAdmin" %>
    ...
    <div class="datalist validator1">
     ...
     <asp:DataList ID="dtlistReceivedMessagesReplyed" runat="server"  DataKeyField="ReceiveMessageId" RepeatLayout="Flow"  >
      ...
      <tr>
        ...
        <tr>
          <td align="right" >&nbsp;</td>
          <td ><asp:Button ID="btnReplyReplyReceivedMessages" runat="server" Text="回复" CssClass="submit_DAqueding"  /></td>
        </tr>
      </table>
