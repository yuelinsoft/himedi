namespace Hidistro.UI.Web.Shopadmin
{
    ...
    public partial class MyReceivedMessagesToAdmin : DistributorPage
    {
        ...
        private void BindData()
        {
            ...
            DbQueryResult receivedMessagesToAdmin = SubsiteCommentsHelper.GetReceivedMessagesToAdmin(query);
            this.messagesList.DataSource = receivedMessagesToAdmin.Data;
            this.messagesList.DataBind();
            this.pager.TotalRecords = receivedMessagesToAdmin.TotalRecords;
            this.pager1.TotalRecords = receivedMessagesToAdmin.TotalRecords;
        }
        ...
        private void btnDeleteSelect_Click(object sender, EventArgs e)
        {
            ...
            {
                SubsiteCommentsHelper.DeleteReceiedMessagesToAdmin(receivedMessageList);
        ...
        {
            long receivedMessageId = (long) this.messagesList.DataKeys[e.RowIndex].Value;
            if (SubsiteCommentsHelper.DeleteReceiedMessageToAdmin(receivedMessageId))
            {
