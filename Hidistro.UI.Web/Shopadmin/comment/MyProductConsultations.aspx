<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="MyProductConsultations.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.MyProductConsultations" %>
...
<!--选项卡-->
    ...
    <div class="searcharea clearfix br_search">
      <ul>
        ...
        <li><abbr class="formselect">店铺分类：<Hi:DistributorProductCategoriesDropDownList ID="dropCategories" runat="server" /></abbr> </li>
...
<div class="areacolumn clearfix">
        ...
        <span class="spanF">管理店铺的所有商品咨询，您可以查询或删除商品咨询 </span></h1>
          ...
          <ul>
                ...
                <li style="float:left; margin-left:15px;">店铺分类：<Hi:DistributorProductCategoriesDropDownList ID="dropCategories" runat="server" /></li>
