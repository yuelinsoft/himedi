namespace Hidistro.UI.Web.Shopadmin
{
    ...
    public partial class AddMyArticleCategory : DistributorPage
    {
        ...
        private void btnSubmitArticleCategory_Click(object sender, EventArgs e)
        {
            ...
            info2.Name = this.txtArticleCategoryiesName.Text.Trim();
            info2.IconUrl = str;
            info2.Description = this.txtArticleCategoryiesDesc.Text.Trim();
