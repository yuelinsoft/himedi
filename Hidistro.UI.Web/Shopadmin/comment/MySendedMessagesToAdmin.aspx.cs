namespace Hidistro.UI.Web.Shopadmin
{
    ...
    public partial class MySendedMessagesToAdmin : DistributorPage
    {
        ...
        private void BindData()
        {
            ...
            DbQueryResult sendedMessagesToAdmin = SubsiteCommentsHelper.GetSendedMessagesToAdmin(query);
            this.messagesList.DataSource = sendedMessagesToAdmin.Data;
            this.messagesList.DataBind();
            this.pager.TotalRecords = sendedMessagesToAdmin.TotalRecords;
            this.pager1.TotalRecords = sendedMessagesToAdmin.TotalRecords;
        }
        ...
        private void btnDeleteSelect_Click(object sender, EventArgs e)
        {
            ...
            {
                SubsiteCommentsHelper.DeleteSendedMessagesToAdmin(sendedMessageList);
        ...
        private void messagesList_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            if (SubsiteCommentsHelper.DeleteSendedMessageToAdmin(sendMessageId))
            {
