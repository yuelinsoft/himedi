<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="UnShippingManualPurchaseOrderDetails.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.UnShippingManualPurchaseOrderDetails" %>
...
<div class="dataarea mainwidth databody">
    ...
    <div class="Purchase">
      <div class="StepsB">
       ...
       <div class="State">
        <ul>
        	<li><strong class="fonts colorE">当前采购单状态：等待供应商发货</strong></li>
