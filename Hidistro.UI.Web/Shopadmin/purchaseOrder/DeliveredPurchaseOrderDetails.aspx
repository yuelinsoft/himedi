<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="DeliveredPurchaseOrderDetails.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.DeliveredPurchaseOrderDetails" %>
    ...
    <div class="Purchase">
       <div class="StepsD">
        <ul>
          ...
          <li><strong class="fonts colorP">第4步</strong> <span class="colorO">辅助发货</span></li>
      ...
      <ul>
            ...
            <li>供应商已经发货</li>
            <li class="Pg_8">
            <span class="submit_tongyi"><asp:HyperLink runat="server" Visible="false" ID="btnSendGood" Text="辅助发货" /></span>
            </li> 
            <li class="Pg_8">
                <div runat="server" id="divRefundDetails" visible="false">
  当前采购单已部分退款给买家,点击查看：<asp:HyperLink runat="server" ID="hlkRefundDetails" ForeColor="#4183F1" Text="退款成功详情" ></asp:HyperLink>
  </div>
           </li> 
