<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="UnPaymentPurchaseOrderDetails.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.UnPaymentPurchaseOrderDetails" %>
      ...
      <div class="State">
        <ul>
            ...
            <li class="Pg_8">
                ...
                <span class="submit_btnguanbi"><a id="lkbtnClosePurchaseOrder" href="javascript:DivWindowOpen(550, 200, 'ClosePurchaseOrder')">取消采购</a></span>
           </li>                     
        </ul>
      </div>
    </div>
