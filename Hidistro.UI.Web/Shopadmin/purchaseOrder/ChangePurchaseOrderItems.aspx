<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="ChangePurchaseOrderItems.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.purchaseOrder.ChangePurchaseOrderItems" %>
...
<asp:Panel runat="server" ID="pnlHasStatus">
    <div>
       <span style="font-weight:700;font-size:14px;font-family:宋体,Arial Narrow;">注意：添加商品</span>
    </div>
    	<!--搜索-->
