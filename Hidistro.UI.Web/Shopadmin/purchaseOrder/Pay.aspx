<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="Pay.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.Pay" %>
    ...
    <div class="datafrom">
      <div class="formitem">
        ...
        <ul class="btntf Pa_160">
          ...
          <asp:Button ID="btnBack1" runat="server" Text="返回采购单" CssClass="submit_DAqueding inbnt" OnClientClick="return CheckPassword();"/>
        </ul>
      </div>
    </div>
</div>
