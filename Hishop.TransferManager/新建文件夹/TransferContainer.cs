...
namespace Hishop.TransferManager
{
    ...
    {
       static volatile TransferContainer _instance = null;
       const string CacheKey = "Hishop_TransferIndexes";
       static readonly object LockHelper = new object();
       static volatile Cache TransferCache = HttpRuntime.Cache;
       ...
       static void AddToExportIndex(Type t, string filename, DataTable dtExporters)
        {
       ...
       static void AddToImportIndex(Type t, string filename, DataTable dtImporters)
        {
       ...
       static void BuildIndex(string pluginPath, DataTable dtExporters, DataTable dtImporters)
        {
       ...
       static Type GetPlugin(string fullName, string tableName)
        {
            DataSet set = TransferCache.Get("Hishop_TransferIndexes") as DataSet;
       ...
       static void InitTable(DataTable table)
        {
       ...
       static byte[] LoadPluginFile(string filename)
        {
            byte[] buffer;
