namespace Hidistro.SaleSystem.Member
{
    ...
    {
       static readonly MemberMasterProvider _defaultInstance = (DataProviders.CreateInstance("Hidistro.SaleSystem.Data.MemberData,Hidistro.SaleSystem.Data") as MemberMasterProvider);
