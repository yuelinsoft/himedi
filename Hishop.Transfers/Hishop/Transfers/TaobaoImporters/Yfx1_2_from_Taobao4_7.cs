                    ...
                    if (!string.IsNullOrEmpty(str2))
                    {
                        if (str2.EndsWith(";"))
                        {
                            ...
                            for (int i = 0; i < (strArray.Length - 1); i++)
                            {
                                ...
                                {
                                    File.Copy(Path.Combine(str + @"\products", str3 + ".tbi"), current.Request.MapPath("~/Storage/master/product/images/" + str4), true);
                                    switch (i)
                                    {
                                        case 0:
                                            row["ImageUrl1"] = "/Storage/master/product/images/" + str4;
                                            break;

                                        case 1:
                                            row["ImageUrl2"] = "/Storage/master/product/images/" + str4;
                                            break;
                                        ...
                                        case 3:
                                            row["ImageUrl4"] = "/Storage/master/product/images/" + str4;
                                            break;

                                        case 4:
                                            row["ImageUrl5"] = "/Storage/master/product/images/" + str4;
                                            break;
                                    }
                                }
                            }
