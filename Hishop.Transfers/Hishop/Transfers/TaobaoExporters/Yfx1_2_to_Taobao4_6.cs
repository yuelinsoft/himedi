namespace Hishop.Transfers.TaobaoExporters
{
    ...
    public class Yfx1_2_to_Taobao4_6 : ExportAdapter
    {
        ...
        public Yfx1_2_to_Taobao4_6(params object[] exportParams) : this()
        {
        ...
        private string GetProductCSV()
        {
            ...
            foreach (DataRow row in this._exportData.Tables["products"].Rows)
            {
                ...
                {
                    str3 = Trim((string) row["ImageUrl1"]);
                ...
                builder.AppendFormat(format, new object[] { 
                    Trim(Convert.ToString(row["ProductName"])), "0", "0", "0", "", "", "b", rowArray[0]["SalePrice"], "0", num, "14", "0", "0", "0", "0", "", 
