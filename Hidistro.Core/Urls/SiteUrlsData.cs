namespace Hidistro.Core.Urls
{
    ...
    public class SiteUrlsData
    {
       ...
       Hidistro.Core.Urls.LocationSet _locationSet = null;
       NameValueCollection _paths = null;
       NameValueCollection _reversePaths = null;
       bool enableHtmRewrite;
       string extension;
       ...
       static ListDictionary CreateTransformers(XmlNode transformers)
        {
       ...
       void CreateUrls(XmlNode urls, ListDictionary transforms)
        {
