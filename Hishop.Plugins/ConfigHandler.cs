namespace Hishop.Plugins
{
    ...
    {
       static void ProcessEmailSender(HttpContext context)
        {
       ...
       void ProcessOpenId(HttpContext context)
        {
            if (context.Request["action"] == "getlist")
            {
       ...
       static void ProcessPaymentRequest(HttpContext context)
        {
            if (context.Request["action"] == "getlist")
            {
       ...
       static void ProcessSMSSender(HttpContext context)
        {
            if (context.Request["action"] == "getlist")
            {
