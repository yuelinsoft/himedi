    ...
    public static class Messenger
    {
        ...
        internal static EmailSender CreateEmailSender(SiteSettings settings, out string msg)
        {
            try
            {
                ...
                return EmailSender.CreateInstance(settings.EmailSender, Cryptographer.Decrypt(settings.EmailSettings));
            }
       ...
       static string GenericOrderMessageFormatter(SiteSettings settings, string username, string stringToFormat, string orderId, decimal total, string memo, string shippingType, string shippingName, string shippingAddress, string shippingZip, string shippingPhone, string shippingCell, string shippingEmail, string shippingBillno, decimal refundMoney, string closeReason)
        {
       ...
       static string GenericUserMessageFormatter(SiteSettings settings, string stringToFormat, string username, string userEmail, string password, string dealPassword)
        {
            stringToFormat = stringToFormat.Replace("$SiteName$", settings.SiteName.Trim());
       ...
       static string GetUserCellPhone(IUser user)
        {
            if (user != null)
            {
                if (user is Member)
