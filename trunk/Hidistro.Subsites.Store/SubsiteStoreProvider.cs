namespace Hidistro.Subsites.Store
{
    ...
    {
       static readonly SubsiteStoreProvider _defaultInstance = (DataProviders.CreateInstance("Hidistro.Subsites.Data.StoreData,Hidistro.Subsites.Data") as SubsiteStoreProvider);
