namespace Hidistro.ControlPanel.Store
{
    ...
    {
       static readonly StoreProvider _defaultInstance = (DataProviders.CreateInstance("Hidistro.ControlPanel.Data.StoreData,Hidistro.ControlPanel.Data") as StoreProvider);
