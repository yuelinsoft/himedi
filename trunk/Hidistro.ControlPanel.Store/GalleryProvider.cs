namespace Hidistro.ControlPanel.Store
{
    ...
    {
       static readonly GalleryProvider _defaultInstance = (DataProviders.CreateInstance("Hidistro.ControlPanel.Data.GalleryData,Hidistro.ControlPanel.Data") as GalleryProvider);
