namespace Hidistro.SaleSystem.Comments
{
    ...
    public abstract class CommentProvider
    {
        ...
        public abstract IList<ArticleInfo> GetArticleList(int? maxNum, string categoryId, string keyWords);
        public abstract IList<ArticleCategoryInfo> GetArticleMainCategories();
        public abstract DataSet GetArticlProductList(int articlId);
