namespace Hishop.Components.Validation
{
    ...
    {
       static IDictionary<PropertyValidatorCacheKey, Validator> attributeAndDefaultConfigurationPropertyValidatorsCache = new Dictionary<PropertyValidatorCacheKey, Validator>();
       static object attributeAndDefaultConfigurationPropertyValidatorsCacheLock = new object();
       static IDictionary<PropertyValidatorCacheKey, Validator> attributeOnlyPropertyValidatorsCache = new Dictionary<PropertyValidatorCacheKey, Validator>();
       static object attributeOnlyPropertyValidatorsCacheLock = new object();
       static IDictionary<PropertyValidatorCacheKey, Validator> defaultConfigurationOnlyPropertyValidatorsCache = new Dictionary<PropertyValidatorCacheKey, Validator>();
       static object defaultConfigurationOnlyPropertyValidatorsCacheLock = new object();
       ...
       static MetadataValidatorBuilder GetTypeValidatorBuilder(MemberAccessValidatorBuilderFactory memberAccessValidatorBuilderFactory)
        {
       ...
       struct PropertyValidatorCacheKey : IEquatable<PropertyValidationFactory.PropertyValidatorCacheKey>
        {
           Type sourceType;
           string propertyName;
           string ruleset;
