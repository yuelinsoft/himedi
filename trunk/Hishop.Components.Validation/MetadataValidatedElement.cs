namespace Hishop.Components.Validation
{
    ...
    {
       IgnoreNullsAttribute ignoreNullsAttribute;
       MemberInfo memberInfo;
       string ruleset;
       Type targetType;
       ValidatorCompositionAttribute validatorCompositionAttribute;
       ...
       void UpdateFlyweight(MemberInfo memberInfo, Type targetType)
        {
