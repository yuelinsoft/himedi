...
namespace Hidistro.ControlPanel.Distribution
{
    ...
    {
        static readonly DistributorProvider _defaultInstance = (DataProviders.CreateInstance("Hidistro.ControlPanel.Data.DistributionData,Hidistro.ControlPanel.Data") as DistributorProvider);
        ...
        public abstract DataTable GetDistributorsNopage(IList<string> fields);
