...
namespace Hidistro.Membership.Core
{
    ...
    {
       static readonly MemberUserProvider _defaultInstance = (DataProviders.CreateInstance("Hidistro.Membership.Data.UserData,Hidistro.Membership.Data") as MemberUserProvider);
