namespace Hidistro.Subsites.Members
{
    ...
    {
       static readonly OpenIdProvider _defaultInstance = (DataProviders.CreateInstance("Hidistro.Subsites.Data.OpenIdData,Hidistro.Subsites.Data") as OpenIdProvider);
