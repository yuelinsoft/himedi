...
{
    public class SubsiteProductCategoriesDropDownList : DropDownList
    {
        bool isTopCategory;
        bool m_AutoDataBind;
        ...
        public override void DataBind()
        {
            ...
            else
            {
                ...
                for (int i = 0; i < categories.Rows.Count; i++)
                {
                    ...
                    Items.Add(new ListItem(FormatDepth((int)categories.Rows[i]["Depth"], (string)categories.Rows[i]["Name"]), cateid));
                }
            }
        }
