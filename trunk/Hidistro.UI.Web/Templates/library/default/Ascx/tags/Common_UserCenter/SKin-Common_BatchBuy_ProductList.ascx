...
<UI:Grid  ID="grdProducts" DataKeyNames="SkuId" runat="server"  AutoGenerateColumns="false"  GridLines="None" Width="100%" ShowHeader="true"  CssClass="User_manForm" HeaderStyle-CssClass="diplayth1">
   <Columns>     
       ...
       <asp:TemplateField HeaderText="购买数量">                       
           <ItemTemplate >
             <asp:TextBox runat="server" ID="txtBuyNum" CssClass="UserInput" Text="1" Width="60" onkeyup="javascript:CheckProductNum(this)" onkeypress="javascript:CheckProductNum(this)"  onblur='CheckProductNum(this)'/>
             <asp:Literal ID="litProductId" runat="server" Text='<%#Eval("ProductId") %>' Visible="false" />
           </ItemTemplate>
       </asp:TemplateField>
