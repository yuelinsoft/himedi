...
<asp:DataList ID="dtlstRegionsSelect" runat="server" Width="100%" DataKeyField="ShippingId">
     ...
     <td><asp:Button ID="btnEdit" class="btn_style_bar" Height="24px" runat="server" CommandName="Edit" Text="编辑" /></td><td><asp:Button ID="btnDelete" class="btn_style_bar" Height="24px" runat="server" CommandName="Delete" Text="删除" /></td>
     </tr>
