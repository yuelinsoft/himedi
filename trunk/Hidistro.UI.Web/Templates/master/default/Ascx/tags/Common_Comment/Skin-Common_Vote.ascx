...
<div class="bMargin">
    <ul class="bPadding10">
        ...
        <li>
         ...
         <ul >
            <input style="padding:0px; margin:0px; border :0px; width:75px; height :25px; " type="button" name='<%# Eval("VoteId") %>' id="btnOK" value="提交/查看" onclick='voteOption(this.name , document.getElementById("<%# this.NamingContainer.ClientID + Convert.ToString(Eval("VoteId"))%>_Value").value);' />
        </ul>
 </div>
