...
namespace Hidistro.UI.Web.Admin
{
    ...
    public partial class GroupBuys : AdminPage
    {
        ...
        private void grdGroupBuyList_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                PromoteHelper.SwapGroupBuySequence(groupBuyId, replaceGroupBuyId, displaySequence, replaceDisplaySequence);
                BindGroupBuy();
            }
        }
        ...
        private void lkbtnDeleteCheck_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow row in grdGroupBuyList.Rows)
            {
                ...
                {
                    num++;
                    PromoteHelper.DeleteGroupBuy(Convert.ToInt32(grdGroupBuyList.DataKeys[row.RowIndex].Value, CultureInfo.InvariantCulture));
                }
            }
            if (num != 0)
            {
