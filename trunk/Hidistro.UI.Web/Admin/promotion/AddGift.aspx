<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="AddGift.aspx.cs" Inherits="Hidistro.UI.Web.Admin.AddGift" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentHolder" Runat="Server">
  ...
  <div class="dataarea mainwidth databody">
      <div class="title title_height m_none td_bottom"> <em><img src="../images/06.gif" width="32" height="32" /></em>
        <h1 class="title_line">添加礼品</h1>
      </div>
      <div class="datafrom">
        <div class="formitem validator2">
          <ul>
            <li><span class="formitemtitle Pw_100">礼品名称：<em >*</em></span>
              <asp:TextBox ID="txtGiftName" runat="server" CssClass="forminput"></asp:TextBox>　<input type="checkbox" id="ckdown" runat="server" checked="checked" />是否允许子站下载
            ...
            <li><span class="formitemtitle Pw_100">详细页标题：</span>
                <asp:TextBox ID="txtGiftTitle" runat="server" CssClass="forminput"></asp:TextBox>
                  <p id="ctl00_contentHolder_txtGiftTitleTip">详细页标题，在1至60个字符之间</p>
            </li>
            <li> <span class="formitemtitle Pw_100">详细页关键字：</span>
               <asp:TextBox ID="txtTitleKeywords" runat="server" CssClass="forminput"></asp:TextBox>
                 <p id="ctl00_contentHolder_txtTitleKeywordsTip">详细页关键字，在1至100个字符之间</p>
            </li>
            <li> <span class="formitemtitle Pw_100">详细页描述：</span>
               <asp:TextBox ID="txtTitleDescription" runat="server" CssClass="forminput"></asp:TextBox>
                 <p id="ctl00_contentHolder_txtTitleDescriptionTip">详细页描述，在1至100个字符之间</p>
            </li>
          </ul>
