<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="NewCoupons.aspx.cs" Inherits="Hidistro.UI.Web.Admin.NewCoupons" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentHolder" Runat="Server">
  ...
  <div class="optiongroup mainwidth">
      <ul>
        ...
        <li><a href="EngagedCoupons.aspx"><span>使用中的优惠券</span></a></li>
                        ...
                        <Columns>  
                               ...
                               <asp:BoundField DataField="UsedCount" HeaderText="已使用数量" HtmlEncode="false" HeaderStyle-CssClass="td_right td_left"></asp:BoundField>   
                                ...
                                <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass="td_left td_right_fff" ItemStyle-Width=250>                                    
                                    <ItemTemplate>
                                        <span class="submit_bianji"><asp:HyperLink ID="hyperLink1"  runat="server" NavigateUrl='<%# Globals.GetAdminAbsolutePath(string.Format("/promotion/EditCoupon.aspx?couponId={0}", Eval("CouponId")))%>'  Text="编辑" /> </span>
