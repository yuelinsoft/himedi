<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="Votes.aspx.cs"  Inherits="Hidistro.UI.Web.Admin.Votes" %>
...
<div class="optiongroup mainwidth">
      <ul>
        ...
        <li><a href="ManageHotKeywords.aspx" class="optionnext"><span>热门关键字</span></a></li>
        <li class="menucurrent"><a href="ManageHotKeywords.aspx" class="optioncurrentend"><span class="optioncenter">投票调查</span></a></li>
      </ul>
</div>
  ...
  <div class="dataarea mainwidth databody">
    ...
    <!-- 添加按钮-->
    <div class="btn">
      <a href="AddVote.aspx" class="submit_jia">添加新投票</a>
    </div>
    <div class="datalist">
    <asp:DataList ID="dlstVote" runat="server" Width="100%" DataKeyField="VoteId" 
            ondeletecommand="dlstVote_DeleteCommand" oneditcommand="dlstVote_EditCommand" 
            onitemcommand="dlstVote_ItemCommand" onitemdatabound="dlstVote_ItemDataBound">
                <HeaderTemplate>
