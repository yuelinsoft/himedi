<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="SetArticleSubject.aspx.cs" Inherits="Hidistro.UI.Web.Admin.SetArticleSubject" %>
      ...
      <div class="formitem validator2">
        <ul>
          ...
          <li> <span class="formitemtitle Pw_100">关联文章分类：</span>
                <Hi:ArticleCategoriesListBox runat="server" ID="listArticleCategories" SelectionMode="Multiple" />
                       </li>
