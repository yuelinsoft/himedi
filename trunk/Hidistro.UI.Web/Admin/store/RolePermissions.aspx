<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="RolePermissions.aspx.cs" Inherits="Hidistro.UI.Web.Admin.RolePermissions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
 <div class=" mainwidth databody">
  ...
  <span>根据不同的部门设置不同的权限，方便控制店铺的管理 </span></div>
	  ...
	  <span class="submit_btnchexiao"><a href="Roles.aspx">返回</a></span></div><br />
         
           
		  <div class="grdGroupList" style="padding-left:10px; margin-top:30px;">
			...
			<div style="padding-left:20px;">
				...
				<div class="PurviewItem">
					<ul>
						<li style="width:90px;font-weight:700;">页面设置：</li>
				...
				<div class="PurviewItem">
					<ul>
					    <li style="width:90px;font-weight:700;">店铺公告：</li>
						<li><label><asp:CheckBox ID="cbAfficheList" runat="server" />公告管理</label></li>
					</ul>
				</div>
				<div class="PurviewItem">
					<ul>
					    <li style="width:90px;font-weight:700;">帮助中心：</li>
				...
				<div class="PurviewItem">
					<ul>
					    <li style="width:90px;font-weight:700;">文章管理：</li>
				...
				<div class="PurviewItem">
					<ul>
					    <li style="width:90px;font-weight:700;">邮件设置：</li>
						<li><label><asp:CheckBox ID="cbEmailSettings" runat="server" />邮件设置</label></li>
					</ul>
				</div>
				<div class="PurviewItem">
					<ul>
					    <li style="width:100px;font-weight:700;">手机短信设置：</li>
			...
			<div style="padding-left:20px;">
				...
				<div class="PurviewItem">
						...
						<li style="margin-left:-10px;"><label><asp:CheckBox ID="cbPurchaseOrders" runat="server"  />采购单：</label></li>
						<li><label><asp:CheckBox ID="cbPurchaseOrdersView" runat="server" />查看</label></li>
						<li><label><asp:CheckBox ID="cbPurchaseOrdersEdit" runat="server" />编辑</label></li>
						<li><label><asp:CheckBox ID="cbPurchaseOrdersDelete" runat="server" />删除</label></li>	
						<li>&nbsp;</li>
						<li style="width:100px;font-weight:700;">&nbsp;</li>
						<li>&nbsp;</li>
						<li style="margin-left:-10px;"><label><asp:CheckBox ID="cbPurchaseOrdersSendGoods" runat="server" />发货</label></li>
						<li><label><asp:CheckBox ID="cbPurchaseOrdersRefund" runat="server" />退款</label></li>
						<li><label><asp:CheckBox ID="cbPurchaseOrdersRemark" runat="server" />备注</label></li>
						</ul>
				...
				<div class="PurviewItem">
						<ul>
						<li style="width:100px;font-weight:700;">分销站点管理：</li>
						<li style="margin-left:-10px;"><label><asp:CheckBox ID="cbManageDistributorSites" runat="server" />分销商站点管理</label></li>
						<li style="width:140px;"><label><asp:CheckBox ID="cbDistributorSiteRequests" runat="server" />分销商站点审核</label></li>							
						</ul>
			...
			<div style="padding-left:20px;">
				...
				<div class="PurviewItem">
					<ul>
					    <li style="width:90px;font-weight:700;">店铺分类：</li>
						<li><label><asp:CheckBox ID="cbManageCategories" runat="server"  />店铺分类：</label></li>
				...
				<div class="PurviewItem">
					...
					<li><label><asp:CheckBox ID="cbSubjectProducts" runat="server" />自定义商品</label></li>
					<li><label><asp:CheckBox ID="cbProductBatchUpload" runat="server" />批量上传</label></li>
					<li style="width:140px;"><label><asp:CheckBox ID="cbMakeProductsPack" runat="server" />制做商品数据包</label></li>
					</ol>
				</div>
			</div>
			<div style="clear:both;margin-top:40px;font-weight:700; color:#000066"><label><asp:CheckBox ID="cbManageUsers" runat="server"  />客户管理</label></div>
			<div class="PurviewItemDivide"></div>
			<div style="padding-left:20px;">
				...
				<div class="PurviewItem">
					<ul>
					    <li style="width:91px;font-weight:700;">会员分析统计：</li>
						<li><label><asp:CheckBox ID="cbBalanceDetailsStatistics" runat="server" />预付款统计</label></li>
						<li><label><asp:CheckBox ID="cbBalanceDrawRequestStatistics" runat="server" />提现统计</label></li>
			...
			<div style="padding-left:20px;">
				<div class="PurviewItem">
					<ul>
						...
						<li><label><asp:CheckBox ID="cbManageOrderRefund" runat="server" />处理退款</label></li>
						<li><label><asp:CheckBox ID="cbManageOrderRemark" runat="server" />管理员备注</label></li>
					</ul>
										
					<ol style="padding-left:206px;">
				...
				<div class="PurviewItem">
					<ul>
					   <li style="width:90px;font-weight:700;">订单可选项：</li>
					    <li style="width:90px;"><label><asp:CheckBox ID="cbOrderLookupLists" runat="server" />订单可选项</label></li>
					</ul>
				</div>
				<div class="PurviewItem">
					<ul>
					    <li style="width:90px;font-weight:700;">支付方式：</li>
						<li><label><asp:CheckBox ID="cbPaymentModes" runat="server" />支付方式</label></li>
					</ul>
				</div>
				<div class="PurviewItem">
					<ul>
					    <li style="width:90px;font-weight:700;">配送方式：</li>
						<li><label><asp:CheckBox ID="cbShippingModes" runat="server" />配送方式管理</label></li>
					</ul>
				</div>
				<div class="PurviewItem">
					<ul>
					    <li style="width:90px;font-weight:700;">销售统计：</li>
			...
			<div style="clear:both;margin-top:40px;font-weight:700; color:#000066"><label><asp:CheckBox ID="cbPromote" runat="server"  />促销活动</label></div>
			<div class="PurviewItemDivide"></div>
			<div style="padding-left:20px;">
				<div class="PurviewItem">
					<ul>
					    <li style="width:90px;font-weight:700;">礼品：</li>
						<li><label><asp:CheckBox ID="cbGifts" runat="server" />礼品</label></li>
					</ul>
				</div>
				<div class="PurviewItem">
					<ul>
					    <li style="width:90px;font-weight:700;">促销活动：</li>
						<li><label><asp:CheckBox ID="cbPromoteSales" runat="server" />促销活动</label></li>
					</ul>
				</div>
				<div class="PurviewItem">
					<ul>
					    <li style="width:90px;font-weight:700;">团购：</li>
						<li><label><asp:CheckBox ID="cbGroupBuy" runat="server" />团购</label></li>
					</ul>
				</div>
				<div class="PurviewItem">
					<ul>
					    <li style="width:90px;font-weight:700;">限时抢购：</li>
			...
			<div style="clear:both;margin-top:40px;font-weight:700; color:#000066"><label><asp:CheckBox ID="cbFeedBack" runat="server" />客户反馈</label></div>
			<div class="PurviewItemDivide"></div>
			<div style="padding-left:20px;">
				<div class="PurviewItem">
					<ul>
