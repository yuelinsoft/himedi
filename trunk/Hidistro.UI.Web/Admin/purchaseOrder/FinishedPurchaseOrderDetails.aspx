<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="FinishedPurchaseOrderDetails.aspx.cs" Inherits="Hidistro.UI.Web.Admin.FinishedPurchaseOrderDetails" Title="无标题页" %>
   ...
   <div class="Purchase">
      ...
      <div class="State">
        <ul>
        	...
        	<li runat="server" id="divRefundDetails" visible="false">
