<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="EditDistributorTradePassword.aspx.cs" Inherits="Hidistro.UI.Web.Admin.EditDistributorTradePassword" %>
        ...
        <ul>
         <li> <span class="formitemtitle Pw_110">分销商名称：</span>
          ...
          <li> <span class="formitemtitle Pw_110">重复输入一次：<em >*</em></span>
	        ...
	        <p id="txtTradePasswordCompareTip" runat="server">两次输入的密码不一致请重新输入</p>
          </li>
      </ul>
