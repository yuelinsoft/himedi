<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" Inherits="Hidistro.UI.Web.Admin.EditDistributorSettings" CodeFile="EditDistributorSettings.aspx.cs" %>
...
<div class="areacolumn clearfix">
		<div class="columnleft clearfix">
                  <ul>
                        <li><a href="ManageDistributor.aspx"><span>分销商管理</span></a></li>
                  </ul>
</div>
      ...
      <div class="formitem validator2">
        <ul>
          ...
          <li> <span class="formitemtitle Pw_110">合作备忘录：</span>
            <asp:TextBox runat="server" ID="txtRemark" TextMode="MultiLine" Columns="60" Rows="8"></asp:TextBox>
