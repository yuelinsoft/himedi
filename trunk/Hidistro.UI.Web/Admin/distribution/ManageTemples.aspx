<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="ManageTemples.aspx.cs" Inherits="Hidistro.UI.Web.Admin.ManageTemples"  %>
...
<div class="dataarea mainwidth databody">
	  ...
	  <div class="datamsg">
	    ...
	    <span class="fonts">当前分销商：<strong class="colorE"><asp:Literal runat="server" ID="litUserName" /></strong></span> <span  class="fonts">独立域名：<strong class="colorE"><asp:Literal runat="server" ID="litDomain"></asp:Literal></strong> <strong><asp:Literal runat="server" ID="litDomain2"/></strong></span>
        <div class="blank12 clearfix"></div>
      </div>
	  <div class="blank12 clearfix"></div>
	  <div class="datafrom">
