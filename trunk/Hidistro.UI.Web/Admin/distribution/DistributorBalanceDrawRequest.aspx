<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" Inherits="Hidistro.UI.Web.Admin.DistributorBalanceDrawRequest" CodeFile="DistributorBalanceDrawRequest.aspx.cs" %>
...
<div class="optiongroup mainwidth">
		<ul>
            <li class="optionstar"><a href="DistributorAccountQuery.aspx" class="optionnext"><span>分销商账户查询</span></a></li>
            <li class="menucurrent"><a href="DistributorBalanceDrawRequest.aspx" class="optioncurrentend"><span class="optioncenter">提现申请记录</span></a></li>
		</ul>
	</div>
	<!--选项卡-->
...
<div class="Visa" id="BandMessage" style="display:none;z-index:1000;">
<h1>银行账号信息</h1>
