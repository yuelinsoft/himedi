<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="EditDistributorPrices.aspx.cs" Inherits="Hidistro.UI.Web.Admin.product.EditDistributorPrices" Title="无标题页" %>
...
<div class="dataarea mainwidth databody">
     ...
     <div class="searcharea clearfix">
        ...
        <ul>
            <li>公式调价：<Hi:DistributorPriceDropDownList ID="ddlDistributorPrice2" runat="server" AllowNull="false" /> = <Hi:PurchaseDropDownList ID="ddlPurchasePrice" runat="server" AllowNull="false" /> </li>
