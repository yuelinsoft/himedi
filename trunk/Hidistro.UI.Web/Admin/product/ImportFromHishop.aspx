<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="ImportFromHishop.aspx.cs" Inherits="Hidistro.UI.Web.Admin.product.ImportFromHishop" Title="无标题页" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="headHolder" runat="server">
 <link rel="stylesheet" href="../css/jquery.treeTable.css" type="text/css" media="screen" />
    ...
    <script type="text/javascript" src="import.hishop.helper.js"></script>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="contentHolder" runat="server">
<div class="optiongroup mainwidth">
		<ul>
			<li class="optionstar"><a href="ImportFromYfx.aspx" class="optionnext"><span>从易分销数据包导入</span></a></li>
			<li class="menucurrent"><a><span>从Hishop数据包导入</span></a></li>
...
<div class="formitem">
            <ul>
              ...
              <li> <span class="formitemtitle Pw_198"></span>
                ...
                <span>
                    上传数据包须小于40M，否则可能上传失败，<br/>您还可以使用FTP工具先将数据包上传到网站的/storage/data/hishop目录以后，再重新打开此页面操作。
                </span>
