<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"  CodeFile="AddProduct.aspx.cs" Inherits="Hidistro.UI.Web.Admin.AddProduct" %>
	    ...
	    <div class="formitem validator1">
          ...
          <li><h2 class="colorE">基本信息</h2></li>
            ...
            <li class="clearfix"><span class="formitemtitle Pw_198">商品描述：</span>
               <Kindeditor:KindeditorControl ID="editDescription" runat="server" Height="300" Width="633" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="validateHolder" runat="server">
    ...
    <script type="text/javascript" language="javascript">       
       function InitValidators() {
           ...
           initValid(new InputValidator('ctl00_contentHolder_txtProductName', 1, 30, false, null, '商品名称字符长度在1-30之间'));
