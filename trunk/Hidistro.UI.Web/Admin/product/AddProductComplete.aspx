<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="AddProductComplete.aspx.cs" Inherits="Hidistro.UI.Web.Admin.AddProductComplete" Title="无标题页" %>
...
<div class="areacolumn clearfix">
		<div class="columnleft clearfix">
                  <ul>
                        <li><a href="ProductOnSales.aspx"><span>商品管理</span></a></li>
                  </ul>
        </div>
      <div class="columnright">
		  ...
		  <div class="Pg_15 Pg_45 fonts">您可以随时到  <span class="Name"><a href="ProductOnSales.aspx">出售中的商品</a> 或 <a href="ProductInStock.aspx">仓库里的商品</a> </span>去编辑商品。</div>
      </div>
