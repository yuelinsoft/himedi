<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="ProductAlert.aspx.cs" Inherits="Hidistro.UI.Web.Admin.ProductAlert" %>
...
<div class="optiongroup mainwidth">
		<ul>
			...
			<li><a href="ProductUnclassified.aspx" class="optionnext"><span>未分类商品</span></a></li>
			<li class="menucurrent"><a href="ProductAlert.aspx"><span>库存报警商品</span></a></li>
				...
				<ul>
					<li class="batchHandleButton">
                       ...
                       <span class="submit_btnshangjia"><asp:LinkButton runat="server" ID="btnUpShelf" Text="上架" /></span>
                        ...
                        <span><asp:LinkButton ID="btnCreateReport" runat="server" Text="导出报表"/> </span>
                    </li>
				</ul>
			</div>
		</div>		
	  ...
	  <div class="datalist">
	    <UI:Grid runat="server" ID="grdProducts" Width="100%" AllowSorting="true" ShowOrderIcons="true" GridLines="None" DataKeyNames="ProductId"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="状态"  ItemStyle-Width="100" HeaderStyle-CssClass="td_right td_left">
                            <itemtemplate>
