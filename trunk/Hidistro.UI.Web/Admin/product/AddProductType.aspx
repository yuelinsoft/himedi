<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="AddProductType.aspx.cs" Inherits="Hidistro.UI.Web.Admin.product.AddProductType" %>
    ...
    <div class="columnright">
          ...
          <ul>
            ...
            <div class="formitem validator4">
              <ul>
                <li> <span class="formitemtitle Pw_110">商品类型名称：<em >*</em></span>
                  <asp:TextBox ID="txtTypeName" CssClass="forminput" runat="server"></asp:TextBox>
