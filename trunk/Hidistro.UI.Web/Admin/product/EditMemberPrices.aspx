<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="EditMemberPrices.aspx.cs" Inherits="Hidistro.UI.Web.Admin.product.EditMemberPrices" Title="无标题页" %>
...
<div class="dataarea mainwidth databody">
     ...
     <div class="searcharea clearfix">
        ...
        <ul>
            <li>公式调价：<Hi:MemberPriceDropDownList ID="ddlMemberPrice2" runat="server" AllowNull="false" /> = <Hi:SalePriceDropDownList ID="ddlSalePrice" runat="server" AllowNull="false" /> </li>
