<%@ Page Language="C#" AutoEventWireup="true" Inherits="Hidistro.UI.Web.Admin.DisplaceCategory" CodeFile="DisplaceCategory.aspx.cs" MasterPageFile="~/Admin/Admin.Master" %>
...
<div class="areacolumn clearfix">
      ...
      <div class="columnright">
          <div class="title"> 
            ...
            <h1>店铺分类批量替换</h1>
            <span>将某一分类的商品批量替换到另一个店铺分类中</span></div>
        <div class="formitem">
            <ul>
              <li> <span class="formitemtitle Pw_160">需要替换的店铺分类：<em >*</em></span>
