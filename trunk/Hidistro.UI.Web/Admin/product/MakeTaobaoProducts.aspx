<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="MakeTaobaoProducts.aspx.cs" Inherits="Hidistro.UI.Web.Admin.product.MakeTaobaoProducts" Title="无标题页" %>
	    ...
	    <UI:Grid runat="server" ID="grdProducts" Width="100%" AllowSorting="true" ShowOrderIcons="true" GridLines="None" DataKeyNames="ProductId"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="操作" ItemStyle-Width="19%" HeaderStyle-CssClass=" td_left td_right_fff">
                            <ItemTemplate>
                                <span class="submit_bianji"><a href="<%#"../../API/MakeTaobaoProductData.aspx?productId="+Eval("ProductId")%>" target="_blank">制作淘宝数据</a></span>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </UI:Grid>
