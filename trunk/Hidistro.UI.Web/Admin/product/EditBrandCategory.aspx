<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="EditBrandCategory.aspx.cs" Inherits="Hidistro.UI.Web.Admin.EditBrandCategory" Title="无标题页" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="validateHolder" runat="server">
 <script type="text/javascript" language="javascript">
            function InitValidators() {
                ...
                initValid(new InputValidator('ctl00_contentHolder_txtReUrl', 0, 50, true, '([a-zA-Z])+(([a-zA-Z_-])?)+', '使用URL重写可以增加分类浏览页面对搜索引擎的友好性，长度限制在60个字符以内'))
