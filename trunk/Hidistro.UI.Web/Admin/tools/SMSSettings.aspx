<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="SMSSettings.aspx.cs" Inherits="Hidistro.UI.Web.Admin.SMSSettings" %>
    ...
    <div class="dataarea mainwidth databody">
        ...
        <div class="datafrom" style="display:none;">
          ...
          <ul class="btntf Pa_140">
		     <asp:Button ID="btnSaveSMSSettings" runat="server"
                                                Text="保 存" CssClass="submit_DAqueding float"></asp:Button>
      </ul>
</div>
<div class="formitem">
<ul>
