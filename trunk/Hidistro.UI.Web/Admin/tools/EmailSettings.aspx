<%@ Page Language="C#" AutoEventWireup="true" Inherits="Hidistro.UI.Web.Admin.EmailSettings" CodeFile="EmailSettings.aspx.cs" MasterPageFile="~/Admin/Admin.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentHolder" runat="server">
  ...
  <div class="dataarea mainwidth databody">
    ...
    <div class="datafrom">
<div class="formitem">
<div class="emailhead"><p>选择ASP.NET邮件组件方式进行正确设置，用以开通自动向用户发送如注册、订单付款等邮件</p><p>如果您需要经常面向大量用户邮箱进行邮件群发，建议你开通更高品质的<font style="color:Red">EDM邮件营销服务。</font><a href="http://www.92hi.com/edm" target="_blank" >点此开通</a></p></div>
          <ul id="pluginContainer" style="margin:5px 0px;">
...
<ul style="margin:5px 0px; height:30px;">
          ...
          <ul class="btntf Pa_140 clear" style="margin:5px 0px; height:30px;">
