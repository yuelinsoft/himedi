<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="DistributorSendedMessages.aspx.cs" Inherits="Hidistro.UI.Web.Admin.DistributorSendedMessages" %>
...
<!--选项卡-->
	...
	<ul>
        <li class="optionstar"><a href="DistributorReceivedMessages.aspx" class="optionnext"><span>收件箱</span></a></li>
        <li class="menucurrent"><a href="javascript:void(0);"><span class="optioncenter">发件箱</span></a></li>
        <li><a href="SendMessageToDistributor.aspx"><span>发送站内信给分销商</span></a></li>
      </ul>
</div>
	<div class="dataarea mainwidth">
    <div class="toptitle"> <em><img src="../images/07.gif" width="32" height="32" /></em> <span class="title_height">你可以查看删除你发送给分销商的站内消息.</span> </div>
    <!--搜索-->
    ...
    <div class="datalist">
        <UI:Grid ID="messagesList" runat="server" ShowHeader="true" AutoGenerateColumns="false" DataKeyNames="SendMessageId" GridLines="None" Width="100%" HeaderStyle-CssClass="table_title">
           <Columns>                 
                ...
                <itemstyle  CssClass="Name" />
                    <ItemTemplate>
                       <a href='<%# Globals.GetAdminAbsolutePath(string.Format("/distribution/ManageDistributor.aspx?userName={0}",Eval("Addressee"))) %>'><asp:Literal ID="litAddressee" runat="server" Text='<%# Eval("Addressee")%>' /></a>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="时间" HeaderStyle-CssClass="td_right td_left">
                    ...
                    <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass="td_right td_left" ItemStyle-Width="80px">
                        ...
                        <ItemTemplate>
                           <span class="submit_shanchu"> <Hi:ImageLinkButton ID="lkbtnDelete" runat="server" IsShow="true"  Text="删除" CommandName="Delete"/></span>
                        </ItemTemplate>
                    </asp:TemplateField>
