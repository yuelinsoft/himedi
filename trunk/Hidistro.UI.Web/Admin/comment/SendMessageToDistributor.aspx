<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="SendMessageToDistributor.aspx.cs" Inherits="Hidistro.UI.Web.Admin.SendMessageToDistributor" EnableSessionState="True"  %>
...
<!--选项卡-->
	<div class="optiongroup mainwidth">
	  <ul>
        ...
        <li class="menucurrent"><a href="javascript:void(0)"><span class="optioncenter">发送站内消息给分销商</span></a></li>
      </ul>
</div>
