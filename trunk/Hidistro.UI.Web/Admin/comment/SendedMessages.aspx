<%@ Page Language="C#" AutoEventWireup="true" Inherits="Hidistro.UI.Web.Admin.SendedMessages" CodeFile="SendedMessages.aspx.cs" MasterPageFile="~/Admin/Admin.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentHolder" runat="server">
	...
	<ul>
        ...
        <li><a href="SendMessage.aspx"><span>发送站内信</span></a></li>
      </ul>
</div>
    ...
    <div class="datalist">
        <UI:Grid ID="messagesList" runat="server" ShowHeader="true" AutoGenerateColumns="false" DataKeyNames="SendMessageId" GridLines="None" Width="100%" HeaderStyle-CssClass="table_title">
           <Columns>                 
                ...
                <itemstyle  CssClass="Name" />
                    <ItemTemplate>
                       <a href='<%# Globals.GetAdminAbsolutePath(string.Format("/member/ManageMembers.aspx?searchKey={0}",Eval("Addressee"))) %>'><asp:Literal ID="litAddressee" runat="server" Text='<%# Eval("Addressee")%>' /></a>
                    </ItemTemplate>
                </asp:TemplateField>
