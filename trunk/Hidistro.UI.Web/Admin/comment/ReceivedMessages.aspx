<%@ Page Language="C#" AutoEventWireup="true" Inherits="Hidistro.UI.Web.Admin.ReceivedMessages" CodeFile="ReceivedMessages.aspx.cs" MasterPageFile="~/Admin/Admin.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentHolder" runat="server">
	...
	<div class="optiongroup mainwidth">
	  <ul>
        ...
        <li class="optionend"><a href="SendMessage.aspx"><span>发送站内信</span></a></li>
      </ul>      	
</div>
      ...
      <UI:Grid ID="messagesList" runat="server" ShowHeader="true" AutoGenerateColumns="false" DataKeyNames="ReceiveMessageId" GridLines="None" Width="100%" HeaderStyle-CssClass="table_title">
            <Columns>                 
                <UI:CheckBoxColumn HeaderStyle-CssClass="table_title"/>
                 ...
                 <asp:TemplateField HeaderText="标题" HeaderStyle-CssClass="td_right td_left">
                  <itemstyle  CssClass="Name" />
                    <ItemTemplate >
                        <a href='<%# Globals.GetAdminAbsolutePath(string.Format("/comment/ReplyReceivedMessages.aspx?ReceiveMessageId={0}", Eval("ReceiveMessageId")))%>' class='<%# Eval("IsRead").ToString()=="False"? "cstrong":"" %>'>
                ...
                <asp:TemplateField HeaderText="发件人" HeaderStyle-CssClass="td_right td_left">
                 <itemstyle  CssClass="Name" />
                    <ItemTemplate>
                        <a href='<%# Globals.GetAdminAbsolutePath(string.Format("/member/ManageMembers.aspx?searchKey={0}",Eval("Addresser"))) %>'><span class='<%# Eval("IsRead").ToString()=="False"? "cstrong":"" %>'><asp:Literal ID="litAddresser" runat="server" Text='<%# Eval("Addresser")%>' /></span></a>
                    </ItemTemplate>
                </asp:TemplateField>
