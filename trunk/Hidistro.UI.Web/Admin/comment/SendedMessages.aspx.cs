...
namespace Hidistro.UI.Web.Admin
{
    ...
    public partial class SendedMessages : AdminPage
    {
        private void BindData()
        {
            ...
            DbQueryResult sendedMessages = NoticeHelper.GetSendedMessages(query);
            messagesList.DataSource = sendedMessages.Data;
            messagesList.DataBind();
            pager.TotalRecords = sendedMessages.TotalRecords;
            pager1.TotalRecords = sendedMessages.TotalRecords;
        }
