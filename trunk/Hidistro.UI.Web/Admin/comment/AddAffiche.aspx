<%@ Page Language="C#" AutoEventWireup="true" Inherits="Hidistro.UI.Web.Admin.AddAffiche" CodeFile="AddAffiche.aspx.cs" MasterPageFile="~/Admin/Admin.Master" %>
...
<div class="areacolumn clearfix">
      ...
      <div class="formitem validator2">
        <ul>
          ...
          <li style="color:Red">如您要为某些关键词添加当前公告内链地址，只需在插入超链接中的URL地址框填写 # 即可。注意：#前无需添加http://。
</li>
