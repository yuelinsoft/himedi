<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="EditArticleCategory.aspx.cs" Inherits="Hidistro.UI.Web.Admin.EditArticleCategory" %>
...
<div class="areacolumn clearfix">
		<div class="columnleft clearfix">
                  <ul>
                        <li><a href="ArticleCategories.aspx"><span>文章分类管理</span></a></li>
                  </ul>
    </div>
