<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="EditMember.aspx.cs" Inherits="Hidistro.UI.Web.Admin.EditMember" %>
...
<div class="areacolumn clearfix">
		<div class="columnleft clearfix">
                  <ul>
                        <li><a href="ManageMembers.aspx"><span>会员管理</span></a></li>
                  </ul>
</div>
      ...
      <div class="formitem validator4 clearfix">
        <ul>
          ...
          <li> <span class="formitemtitle Pw_110">账户状态：<em >*</em></span>
                <abbr class="formselect">
                   <Hi:ApprovedDropDownList runat="server" ID="ddlApproved" AllowNull="false" />
                 </abbr>
          </li>
          <li> <span class="formitemtitle Pw_110">会员等级：<em >*</em></span>
            <abbr class="formselect">
