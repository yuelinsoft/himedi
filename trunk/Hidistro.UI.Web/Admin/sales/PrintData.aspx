<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintData.aspx.cs" Inherits="Hidistro.UI.Web.Admin.PrintData" %>
...
<div class="dataarea mainwidth databody">
  ...
  <tr>
    ...
    <td colspan="3">
      ...
      <span class="fonts colorB">(您可以将编辑过的收货人信息更新到订单)</span>
    </td>
    </tr>
</table>
    </div>
  ...
  <div class="datafrom" style="padding-bottom:1px;">
   ...
   <tr>
    ...
    <td colspan="3"><Hi:ShippersDropDownList runat="server" ID="ddlShoperTag" /></td>
    </tr>
  <tr>
