<%@ Page Language="C#" AutoEventWireup="true" Inherits="Hidistro.UI.Web.Admin.EditPaymentType" CodeFile="EditPaymentType.aspx.cs" MasterPageFile="~/Admin/Admin.Master" %>
...
<div class="areacolumn clearfix validator4">
		<div class="columnleft clearfix">
                  <ul>
                        <li><a href="PaymentTypes.aspx"><span>支付方式管理</span></a></li>
                  </ul>
  </div>
