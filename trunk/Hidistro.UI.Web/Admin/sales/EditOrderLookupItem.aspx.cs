...
namespace Hidistro.UI.Web.Admin
{
    ...
    public partial class EditOrderLookupItem : AdminPage
    {
        ...
        {
            OrderLookupItemInfo info2 = new OrderLookupItemInfo();
            info2.Name = txtName.Text.Trim();
            info2.CalculateMode = new int?(radlCalculateMode.SelectedValue);
            info2.UserInputTitle = txtUserInputTitle.Text.Trim();
            OrderLookupItemInfo info = info2;
