<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="FinishedOrderDetails.aspx.cs" Inherits="Hidistro.UI.Web.Admin.FinishedOrderDetails"  %>
...
<div class="dataarea mainwidth databody">
  ...
  <div class="Purchase">
      ...
      <div class="State">
        <ul>
        	<li><strong class="fonts colorE">当前订单状态：交易成功</strong><div  runat="server" id="divRefundDetails" visible="false">
  当前订单已部分退款给买家,点击查看：<asp:HyperLink runat="server" ID="hlkRefundDetails" ForeColor="#4183F1" Text="退款成功详情" ></asp:HyperLink>
  </div></li>
        	
            <li class="Pg_8">
                 <span class="submit_btnbianji"><a href="javascript:DivWindowOpen(600,400,'RemarkOrder');">备注</a></span>
           </li>                     
        </ul>
      </div>
    </div>
