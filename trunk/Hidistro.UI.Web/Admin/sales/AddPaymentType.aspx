<%@ Page Language="C#" AutoEventWireup="true" Inherits="Hidistro.UI.Web.Admin.AddPaymentType" CodeFile="AddPaymentType.aspx.cs" MasterPageFile="~/Admin/Admin.Master" %>
...
<div class="areacolumn clearfix validator4">
		<div class="columnleft clearfix">
                  <ul>
                        <li><a href="PaymentTypes.aspx"><span>支付方式列表</span></a></li>
                  </ul>
  </div>
    ...
    <ul class="btn Pa_110 clear">
     <asp:Button ID="btnCreate" runat="server" OnClientClick="return PageIsValid();" Text="添 加" OnClick="btnCreate_Click"  CssClass="submit_DAqueding"/>
            </ul>
	      </div>
  </div>
</div>
