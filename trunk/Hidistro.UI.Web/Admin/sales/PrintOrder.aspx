<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintOrder.aspx.cs" Inherits="Hidistro.UI.Web.Admin.sales.PrintOrder" %>
...
<head runat="server">
    ...
    <style type="text/css" media="screen">
        ...
        .Order_Item table tr td{  border-left-width:0px; border-right-width:0px; text-align:left;}
...
<body>
    ...
    <div class="dataarea mainwidth" style="border-style:none;">
        ...
        <div></div>
        <div class="Order_Item" style="height:40px; margin-top:10px;"><strong>签名：</strong></div>
    </div>
