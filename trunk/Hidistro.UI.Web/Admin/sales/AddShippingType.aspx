...
<div class="areacolumn clearfix">
		<div class="columnleft clearfix">
                  <ul>
                        <li><a href="ShippingTypes.aspx"><span>配送方式列表</span></a></li>
                  </ul>
</div>
    ...
    <asp:Button ID="btnCreate" runat="server" OnClientClick="return ValidateAll();" OnClick="btnCreate_Click"  CssClass="submit_DAqueding inbnt" Text="添 加"/>
            </ul>
	      </div>
  </div>
</div>
