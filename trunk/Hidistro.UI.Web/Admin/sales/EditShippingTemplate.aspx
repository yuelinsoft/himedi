<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="EditShippingTemplate.aspx.cs" Inherits="Hidistro.UI.Web.Admin.sales.EditShippingTemplate" %>
...
function InitValidators()
{
    ...
    initValid(new InputValidator('ctl00_contentHolder_txtWeight', 1, 10, false, '-?[0-9]\\d*', '起步重量不能为空,必须为正整数,限制在100千克以内'))
    appendValid(new NumberRangeValidator('ctl00_contentHolder_txtWeight', 0, 100000, ' 必须为非负数字,限制在100千克以内'));
    initValid(new InputValidator('ctl00_contentHolder_txtAddWeight', 1, 10, true, '-?[0-9]\\d*', '加价重量必须为正整数,限制在100千克以内'))
   ...
   {  
     ...
     　　var fagtxtRegionPrice=document.getElementById("ctl00_contentHolder_txtRegionPrice").value;//起步价
     　　　var fagtxtAddRegionPrice=document.getElementById("ctl00_contentHolder_txtAddRegionPrice").value;//加价    　　　
     　　   if(fagtxtRegion.length<=0 ||fagtxtRegion.length>60){alert("配送方式名称不能为空，长度限制在60字符以内");return false;}
...
<div class="areacolumn clearfix">
		<div class="columnleft clearfix">
                  <ul>
                        <li><a href="ManageShippingTemplates.aspx"><span>运费模板列表</span></a></li>
                  </ul>
</div>
		<div class="columnright">
		  ...
		  <div class="formitem validator4">
		    <ul>
		      <li> <span class="formitemtitle Pw_110">模板名称：<em >*</em></span>
		      ...
		      <li><span class="formitemtitle Pw_110">起步重量：<em >*</em></span>
		       <asp:TextBox ID="txtWeight" runat="server" class="forminput"></asp:TextBox>(克)
		       <p id="ctl00_contentHolder_txtWeightTip">起步重量不能为空,必须为正整数,限制在100千克以内</p>
		      </li>
              <li><span class="formitemtitle Pw_110">加价重量：</span>
		        <asp:TextBox ID="txtAddWeight" runat="server" class="forminput"></asp:TextBox>(克)
		        <p id="ctl00_contentHolder_txtAddWeightTip">加价重量必须为正整数,限制在100千克以内</p>
		      </li>
              <li><span class="formitemtitle Pw_110">默认起步价：<em >*</em></span>
