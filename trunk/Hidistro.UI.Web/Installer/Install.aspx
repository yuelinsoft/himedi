<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Install.aspx.cs" Inherits="Hidistro.UI.Web.Installer.Install" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>易分销 2.0 安装向导</title>
...
<div class="wrap">
	...
	<div class="form">
		...
		<p>
		    ...
		    <asp:Button ID="btnInstall" runat="server" Text="确认，提交" CssClass="done" OnClick="btnInstall_Click" />
		</p>
...
//                $("#btnInstall").bind("click", function() { RunInstall(); });
            });
...
//                DisableButtons();
//                GetValues();
//                var resultData = Callback("Install")
