<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" EnableSessionState="True" AutoEventWireup="true" CodeFile="BalanceDraw.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.BalanceDraw" %>
...
<div class="dataarea mainwidth td_top_ccc">
  ...
  <div class="areaform validator1">
	    <ul>
	      ...
	      <li><span class="formitemtitle Pw_198">开银行名称：<em>*</em></span>
