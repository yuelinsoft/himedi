<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="EditMyAdvPositions.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.EditMyAdvPositions" %>
      ...
      <div class="formitem validator2">
        <ul>
          ...
          <li> <span class="formitemtitle Pw_100">广告位内容：</span>
            <Kindeditor:KindeditorControl FileCategoryJson="~/Shopadmin/FileCategoryJson.aspx" UploadFileJson="~/Shopadmin/UploadFileJson.aspx" FileManagerJson="~/Shopadmin/FileManagerJson.aspx" ID="fcContent" runat="server" IsAdvPositions="true" Width="550" Height="200" />
          </li>
      </ul>
