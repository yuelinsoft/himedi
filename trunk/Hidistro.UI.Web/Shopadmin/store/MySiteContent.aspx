<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="MySiteContent.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.MySiteContent" %>
        ...
        <div class="formitem validator1">
          <ul>
            ...
            <li> <span class="formitemtitle Pw_198">简单介绍：</span>
              ...
              <p id="txtSiteDescriptionTip" runat="server">简单介绍TITLE的长度限制在60字符以内</p>
            </li>
            <li> <span class="formitemtitle Pw_198">店铺描述：</span>
              ...
              <p id="txtSearchMetaDescriptionTip" runat="server">店铺描述META_DESCRIPTION的长度限制在100字符以内</p>
            </li>
            <li> <span class="formitemtitle Pw_198">搜索关键字：</span>
              <asp:TextBox ID="txtSearchMetaKeywords" CssClass="forminput" runat="server" />
              <p id="txtSearchMetaKeywordsTip" runat="server">搜索关键字META_KEYWORDS的长度限制在100字符以内，多个关键字之间用,号分开</p>
            </li>
              <h2>在线客服设置</h2>
