<%@ Page Language="C#" MasterPageFile="~/ShopAdmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="MyArticleSubject.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.MyArticleSubject" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
 <div class="dataarea mainwidth td_top_ccc">
  ...
  <h1 class=" title_height">“<a href="ManageMyThemes.aspx"><asp:Literal runat="server" ID="litThemName"/></a>”模板的文章栏目</h1>
