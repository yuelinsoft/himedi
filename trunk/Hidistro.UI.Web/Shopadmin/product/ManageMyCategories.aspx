<%@ Page Language="C#" AutoEventWireup="true" Inherits="Hidistro.UI.Web.Shopadmin.ManageMyCategories" CodeFile="ManageMyCategories.aspx.cs" MasterPageFile="~/Shopadmin/Shopadmin.Master" %>
...
<div class="dataarea mainwidth databody">
  ...
  <span>管理店铺的店铺分类.您可以添加、编辑、删除店铺分类</span></div>
		...
		<!-- 添加按钮-->
   <div class="btn"><a href="AddMyCategory.aspx" class="submit_jia">添加新店铺分类</a></div>
<!--结束-->
		<!--数据列表区域-->
  <div class="datalist">
