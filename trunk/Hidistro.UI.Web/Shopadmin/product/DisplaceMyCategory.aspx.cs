...
{
    public partial class DisplaceMyCategory : DistributorPage
    {
        ...
        private void btnSaveCategory_Click(object sender, EventArgs e)
        {
            ...
            else if (SubsiteCatalogHelper.DisplaceCategory(dropCategoryFrom.SelectedValue.Value, dropCategoryTo.SelectedValue.Value) == 0)
            {
