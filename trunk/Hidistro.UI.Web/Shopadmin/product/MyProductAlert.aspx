<%@ Page Language="C#" MasterPageFile="~/Shopadmin/Shopadmin.Master" AutoEventWireup="true" CodeFile="MyProductAlert.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.MyProductAlert" %>
...
<div class="optiongroup mainwidth">
		<ul>
			<li class="optionstar"><a href="MyProductOnSales.aspx" ><span>出售中的商品</span></a></li>
			<li><a href="MyProductUnSales.aspx"><span>下架区的商品</span></a></li>
			<li><a href="MyProductInStock.aspx"><span>仓库中的商品</span></a></li>
			<li><a href="MyProductUnclassified.aspx"><span>未分类商品</span></a></li>
			<li class="menucurrent"><a href="MyProductAlert.aspx"><span >库存报警商品</span></a></li>
		</ul>
	</div>
	<!--选项卡-->
			...
			<ul>
				...
				<li>
					<abbr class="formselect">
					 ...
					 <li>
					<abbr class="formselect">
						<Hi:ProductSaleStatusDropDownList runat="server" ID="dropproductsale" NullToDisplay="--请选择商品状态--" CssClass="forminput"></Hi:ProductSaleStatusDropDownList>
					</abbr>
				</li>
			...
			<div class="batchHandleArea">
				<ul>
                    ...
                    <span class="submit_btnxiajia"><asp:LinkButton runat="server" ID="btnInStock" Text="入库"  /></span>
                     <span style="display:none;"><asp:LinkButton ID="btnCreateReport" runat="server" Text="导出报表"/> </span>
                    </li>
				</ul>
			</div>
		</div>
                    ...
                    SortOrder="Desc" SortOrderBy="DisplaySequence" AutoGenerateColumns="false" HeaderStyle-CssClass="table_title">
                     <Columns>
                        ...
                        <asp:TemplateField ItemStyle-Width="280px" HeaderText="商品" HeaderStyle-CssClass="td_right td_left">
                            ...
                            <asp:TemplateField HeaderText="状态" HeaderStyle-Width="70px" HeaderStyle-CssClass="td_right td_left">
                        <ItemTemplate>
                            <%#ShowStatus(Eval("SaleStatus"))%>
                        </ItemTemplate>
                    </asp:TemplateField>
                         <asp:TemplateField HeaderText="最低零售价(元)" HeaderStyle-Width="110px" HeaderStyle-CssClass="td_right td_left">
                        <ItemTemplate>
                            <%#Eval("LowestSalePrice", "{0:F2}")%>
                        </ItemTemplate>
                    </asp:TemplateField>
                         <Hi:MoneyColumnForAdmin HeaderText=" 一口价"
                            ItemStyle-Width="50" DataField="SalePrice"  HeaderStyle-CssClass="td_right td_left"  />
                        <Hi:MoneyColumnForAdmin HeaderText="采购价"
                            ItemStyle-Width="50" DataField="PurchasePrice" HeaderStyle-CssClass="td_right td_left"  />                    
                         <asp:TemplateField HeaderText="差价" ItemStyle-Width="70" HeaderStyle-CssClass="td_right td_left">
                            <itemtemplate>
                        ...
                        <asp:TemplateField HeaderText="操作" ItemStyle-Width="200px" HeaderStyle-CssClass=" td_left td_right_fff">
                            <ItemTemplate>
