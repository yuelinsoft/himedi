<%@ Page Title="" Language="C#" MasterPageFile="~/ShopAdmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="MyCountDowns.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.MyCountDowns" %>
	...
	<div class="dataarea mainwidth">
	    ...
	    <div class="searcharea clearfix br_search">
			<ul class="a_none_left">
				...
				<li><asp:Button ID="btnSearch" runat="server" CssClass="searchbutton"　Text="查询" OnClick="btnSearch_Click" /></li>
		  </ul>
	  </div>
...
<div class="functionHandleArea clearfix m_none">
			...
			<div class="batchHandleArea">
				<ul>
                    ...
                    <span class="delete"><Hi:ImageLinkButton ID="lkbtnDeleteCheck" IsShow="true" runat="server" OnClick="lkbtnDeleteCheck_Click" >删除</Hi:ImageLinkButton></span>
                    </li>
				</ul>
			</div>
	  </div>
		...
		<!--数据列表区域-->
	  <div class="datalist">
		    <UI:Grid ID="grdCountDownsList" runat="server" ShowHeader="true" OnRowDeleting="grdGroupBuyList_RowDeleting"  OnRowCommand="grdGroupBuyList_RowCommand" AutoGenerateColumns="false" SortOrderBy="DisplaySequence"  DataKeyNames="CountDownId" HeaderStyle-CssClass="table_title" GridLines="None" Width="100%">
            <Columns>                 
