<%@ Page Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="EditMyCoupon.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.EditMyCoupon"  %>
...
<div class="areacolumn clearfix">
      ...
      <ul class="btn Pa_100 clear">
         <asp:Button ID="btnEditCoupons" runat="server" Text="保 存"  CssClass="submit_DAqueding" OnClick="btnEditCoupons_Click"  />
        </ul>
      </div>
