<%@ Page Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="AddMyCoupon.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.AddMyCoupon"  %>
...
<div class="columnleft clearfix"><ul><li><a href="MyNewCoupons.aspx"><span>优惠券管理</span></a></li></ul></div>
      ...
      <div class="formitem validator2">
        <ul>
          ...
          <li>
	                <span class="formitemtitle Pw_100">导出数量：<em >*</em></span>
		            <asp:TextBox ID="txtCount" runat="server" Text="0" CssClass="forminput"></asp:TextBox>
 <p id="ctl00_contentHolder_txtCountTip">导出数量只能是数字，必须大于等于O,0表示不导出</p>
	            </li>
      </ul>
      <ul class="btn Pa_100">
         <asp:Button ID="btnAddCoupons" runat="server" Text="添加" OnClientClick="return PageIsValid();"  CssClass="submit_DAqueding" OnClick="btnAddCoupons_Click"  />
        </ul>
      </div>
