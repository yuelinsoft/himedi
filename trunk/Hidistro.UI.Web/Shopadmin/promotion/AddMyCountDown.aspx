<%@ Page Title="" Language="C#" MasterPageFile="~/ShopAdmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="AddMyCountDown.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.AddMyCountDown" %>
...
<div class="columnleft clearfix"><ul><li><a href="MyCountDowns.aspx"><span>限时抢购管理</span></a></li></ul></div>
      ...
      <li>
         <asp:Button ID="btnAddCountDown" runat="server" Text="添加" OnClientClick="return PageIsValid();"  CssClass="submit_DAqueding" OnClick="btnbtnAddCountDown_Click"  />
         </li>
        </ul>
      </div>
