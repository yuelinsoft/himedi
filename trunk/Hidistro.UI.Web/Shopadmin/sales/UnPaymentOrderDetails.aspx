<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="UnPaymentOrderDetails.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.UnPaymentOrderDetails" %>
        ...
        <ul>
            ...
            <li class="Pg_8"><span class="submit_btnxiugai"><asp:HyperLink runat="server" ID="lkbtnEditPrice"   Height="25px" Text="修改价格" /></span>
                <span class="submit_btnbianji"><a href="javascript:DivWindowOpen(550, 350, 'RemarkOrder')">备注</a></span>
                 <span class="submit_btnguanbi"><a href="javascript:DivWindowOpen(550, 250, 'closeOrder')" >关闭订单</a></span>
           </li>                     
        </ul>
      </div>
    </div>
