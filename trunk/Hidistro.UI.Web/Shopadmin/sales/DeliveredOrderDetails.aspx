<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="DeliveredOrderDetails.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.DeliveredOrderDetails" %>
    ...
    <div class="Purchase">
      ...
      <div class="State">
        <ul>
            ...
            <li runat="server" id="liRefund" visible="false">如果需要给买家退款.请点击 <abbr><asp:HyperLink runat="server" ID="hlkRefund" Text="退款" Target="_blank"></asp:HyperLink></abbr></li>
            <li class="Pg_8">
...
<script type="text/javascript">
    window.onload = function Init() {
        ...
        $.ajax({
        url: "DeliveredOrderDetails.aspx?OrderId=" + OrderId + "&isCallback=true",
