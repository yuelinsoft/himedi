<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="FinishedOrderDetails.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.FinishedOrderDetails" %>
...
<script type="text/javascript">
    window.onload = function Init() {
        ...
        $.ajax({
        url: "FinishedOrderDetails.aspx?OrderId=" + OrderId + "&isCallback=true",
