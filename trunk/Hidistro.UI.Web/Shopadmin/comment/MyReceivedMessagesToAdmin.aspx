<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="MyReceivedMessagesToAdmin.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.MyReceivedMessagesToAdmin" %>
                 ...
                 <asp:TemplateField HeaderText="标题" HeaderStyle-CssClass="td_right td_left">
                  <itemstyle  CssClass="Name" />
                    <ItemTemplate >
                        ...
                        <a href='<%# Globals.ApplicationPath+string.Format("/Shopadmin/comment/ReplayMyReceivedMessageToAdmin.aspx?ReceiveMessageId={0}", Eval("ReceiveMessageId"))%>' class='<%# Eval("IsRead").ToString()=="False"? "cstrong":"" %>'>
