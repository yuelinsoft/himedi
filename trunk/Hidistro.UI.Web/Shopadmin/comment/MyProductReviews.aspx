<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="MyProductReviews.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.MyProductReviews" %>
			...
			<ul>
				...
				<li>
					<abbr class="formselect">
					  店铺分类：<Hi:DistributorProductCategoriesDropDownList ID="dropCategories" runat="server" />
					</abbr>
				</li>
				<li>
