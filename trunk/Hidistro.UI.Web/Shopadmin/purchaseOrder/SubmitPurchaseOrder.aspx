<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="SubmitPurchaseOrder.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.SubmitPurchaseOrder" %>
...
<div class="dataarea mainwidth databody">
    <div class="title  m_none td_bottom"> <em><img src="../images/+003.gif" width="32" height="32" /></em>
	    <h1>提交采购单 - 填写收货人信息 </h1>
	    ...
	    <div class="formitem validator1">
	      <ul>
	       <h2 class="colorE">注意：正确填写收货人地址，以便尽快收到商品！</h2>
	        ...
	        <li><span class="formitemtitle Pw_198">采购模式：</span><input type="radio" id="radOrdinary" name="radmode" checked="checked" onclick="ChooseMode()" />普通模式　<input type="radio" id="radSell" name="radmode" onclick="ChooseMode()" />代销模式</li>
	        ...
	        <li> <span class="formitemtitle Pw_198">详细地址：<em>*</em></span>
	          <textarea id="txtAddress" runat="server" rows="2" cols="48" class="forminput"></textarea>
...
<script type="text/javascript" language="javascript">
    ...
    function ValidationModeName() {
        ...
        function ChooseMode(){
            if($("#radOrdinary").attr("checked")){
                $("#liaddress").css("display","none");
            }else{
                $("#liaddress").css("display","block");
            }
        }
    </script>
</asp:Content>
