<%@ Page Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeFile="FinishedPurchaseOrderDetails.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.FinishedPurchaseOrderDetails" Title="无标题页" %>
