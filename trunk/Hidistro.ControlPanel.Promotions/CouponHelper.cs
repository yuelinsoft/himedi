namespace Hidistro.ControlPanel.Promotions
{
    ...
    public static class CouponHelper
    {
        ...
        public static DbQueryResult GetOverdueCoupons(Pagination page)
        {
            return PromotionsProvider.Instance().GetOverdueCoupons(page);
        }
        ...
        {
            return PromotionsProvider.Instance().GetUsingCoupons(page);
        }
