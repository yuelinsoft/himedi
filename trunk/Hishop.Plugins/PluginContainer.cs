...
namespace Hishop.Plugins
{
    public abstract class PluginContainer
    {
       ...
       void AddPlugin(Type t, string filename, XmlDocument catalog, XmlNode mapNode)
        {
       ...
       void BuildIndex(XmlDocument catalog, XmlNode mapNode)
        {
       ...
       static bool CheckIsPlugin(Type t, string interfaceName)
        {
            try
            {
       ...
       static XmlNode FindNode(XmlNodeList nodeList, int sequence)
        {
       ...
       Type GetPlugin(string baseName, string name, string attname)
        {
       ...
       static byte[] LoadPlugin(string filename)
        {
            byte[] buffer;
