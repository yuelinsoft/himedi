...
namespace Hidistro.Messages
{
    ...
    {
       static readonly EmailQueueProvider DefaultInstance = (DataProviders.CreateInstance("Hidistro.Messages.Data.EmailQueueData,Hidistro.Messages.Data") as EmailQueueProvider);
