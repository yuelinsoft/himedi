...
namespace Hidistro.Messages
{
    ...
    {
       static readonly MessageTemplateProvider DefaultInstance = (DataProviders.CreateInstance("Hidistro.Messages.Data.MessageTemplateData,Hidistro.Messages.Data") as MessageTemplateProvider);
