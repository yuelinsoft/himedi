namespace Hidistro.UI.ControlPanel.Utility
{
    ...
    public class ImageTypeLabel : Label
    {
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            if (str3 == "0")
            {
                str = str + "<li><a href=\"" + Globals.ApplicationPath + "/admin/store/ImageData.aspx?pageSize=20&ImageTypeId=0\" class='classLink'><s></s><strong>默认分类</strong></a></li>";
            }
            else
            {
                str = str + "<li><a href=\"" + Globals.ApplicationPath + "/admin/store/ImageData.aspx?pageSize=20&ImageTypeId=0\"><s></s><strong>默认分类</strong></a></li>";
            }
