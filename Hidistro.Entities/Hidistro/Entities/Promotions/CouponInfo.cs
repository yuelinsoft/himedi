namespace Hidistro.Entities.Promotions
{
    ...
    public class CouponInfo
    {
       ...
       int _UsedCount ;
        ...
        public CouponInfo(string name, DateTime closingTime, string description, decimal? amount, decimal discountValue)
        {
            this.Name = name;
        ...
        public CouponInfo(int couponId, string name, DateTime closingTime, string description, decimal? amount, decimal discountValue)
        {
