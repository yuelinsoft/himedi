...
namespace Hidistro.Membership.ASPNETProvider
{
    internal static class SecUtility
    {
       ...
       static XmlNode GetAndRemoveAttribute(XmlNode node, string attrib, bool fRequired)
        {
       ...
       static XmlNode GetAndRemoveBooleanAttributeInternal(XmlNode node, string attrib, bool fRequired, ref bool val)
        {
       ...
       static XmlNode GetAndRemoveNonEmptyStringAttributeInternal(XmlNode node, string attrib, bool fRequired, ref string val)
        {
       ...
       static XmlNode GetAndRemoveStringAttributeInternal(XmlNode node, string attrib, bool fRequired, ref string val)
        {
            XmlNode node2 = GetAndRemoveAttribute(node, attrib, fRequired);
            if (node2 != null)
            {
