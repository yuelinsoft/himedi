...
namespace Hidistro.Membership.Context
{
    ...
    {
       static readonly BizActorProvider _defaultInstance = (DataProviders.CreateInstance("Hidistro.Membership.Data.BizActorData,Hidistro.Membership.Data") as BizActorProvider);
