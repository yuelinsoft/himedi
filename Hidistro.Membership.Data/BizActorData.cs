...
namespace Hidistro.Membership.Data
{
    public class BizActorData : BizActorProvider
    {
        ...
        bool ChangeTradePassword(string tableName, string username, string oldPassword, string newPassword)
        {
            string str;
            int num;
        ...
        bool CheckTradePassword(string tableName, string username, string password)
        {
            string salt;
            int format;
            return this.CheckTradePassword(tableName, username, password, out salt, out format);
        }

        bool CheckTradePassword(string tableName, string username, string password, out string salt, out int passwordFormat)
        {
            string str;
            bool flag;
        ...
        void GetPasswordWithFormat(string tableName, string username, out bool success, out int passwordFormat, out string passwordSalt, out string passwordFromDb)
        {
            passwordFormat = 0;
            passwordSalt = null;
            passwordFromDb = null;
